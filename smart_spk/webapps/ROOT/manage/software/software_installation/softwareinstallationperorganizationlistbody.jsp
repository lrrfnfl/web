...
<% } %>
					...
					$('.inner-center .pane-header').text('부서 소프트웨어 설치 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');
				} else if (objTreeReference.get_selected().attr("node_type") == 'user') {
					$('.inner-center .pane-header').text('사용자 소프트웨어 설치 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');
				} else {
	...
	<div class="ui-layout-content">
		<div id="softwareinstallation-list" style="display: none;">
			<div id="search-condition" class="inline-search-condition">
				...
				<input type="text" id="searchsoftwarename" name="searchsoftwarename" class="text ui-widget-content" />
