...
<% } %>
	...
	<!--
		...
		reloadDefaultLayout = function() {
			var layoutHeight = $('#softwarelicence-tree').parent().height();
			var paddingTop = parseInt($('#softwarelicence-tree').css("padding-top"));
			var paddingBottom = parseInt($('#softwarelicence-tree').css("padding-bottom"));
			if ($('#softwarelicence-tree').length) {
				$('#softwarelicence-tree').height(layoutHeight - paddingTop - paddingBottom);
				$('#softwarelicence-tree').mCustomScrollbar('update');
			}
...
<body>
	<div class="ui-layout-north">
		...
		<div class="site-map-path">
			...
			<span class="parent-path">소프트웨어 관리</span>
			<ul class="ui-helper-clearfix icons"><li><span class="ui-icon ui-icon-carat-1-e"></span></li></ul>
			<span class="parent-path">소프트웨어 라이센스</span>
			<ul class="ui-helper-clearfix icons"><li><span class="ui-icon ui-icon-carat-1-e"></span></li></ul>
			<span class="current-path">소프트웨어 라이센스 관리</span>
		</div>
	</div>
