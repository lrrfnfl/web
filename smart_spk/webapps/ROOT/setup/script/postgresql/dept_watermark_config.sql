-- Table: dept_watermark_config

-- DROP TABLE dept_watermark_config;

CREATE TABLE dept_watermark_config
(
  ...
  CONSTRAINT "PK_DEPT_WATERMARK_CONFIG" PRIMARY KEY (companyid, deptcode),
  CONSTRAINT "FK_DEPT_WATERMARK_CONFIG_DEPT" FOREIGN KEY (companyid, deptcode)
