-- Table: company_print_control_config

-- DROP TABLE company_print_control_config;

CREATE TABLE company_print_control_config
(
  ...
  CONSTRAINT "PK_COMPANY_PRINT_CONTROL_CONFIG" PRIMARY KEY (companyid),
  CONSTRAINT "FK_COMPANY_PRINT_CONTROL_CONFIG_COMPANY" FOREIGN KEY (companyid)
