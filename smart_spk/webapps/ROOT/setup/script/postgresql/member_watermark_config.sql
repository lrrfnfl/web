-- Table: member_watermark_config

-- DROP TABLE member_watermark_config;

CREATE TABLE member_watermark_config
(
  ...
  CONSTRAINT "PK_MEMBER_WATERMARK_CONFIG" PRIMARY KEY (companyid, deptcode, userid),
  CONSTRAINT "FK_MEMBER_WATERMARK_CONFIG_MEMBER" FOREIGN KEY (companyid, deptcode, userid)
