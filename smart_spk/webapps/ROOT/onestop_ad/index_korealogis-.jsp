...
<div id="main-page" class="wrap" style="display:none;">
	<div class="wrap-inner">
		...
		<div class="container">
			...
			<div class="download">
				<p class="block-title">설명서 다운로드</p>
				<a href="/downfiles/manuals/SPK_RK_admin guide.zip">
					<img src="images/download_admin_guide.png" alt="" style="width: 345px;" />
				</a>
				<a href="/downfiles/manuals/SPK_RK_user guide.zip">
					<img src="images/download_user_guide.png" alt="" style="width: 345px; margin-left: 5px;"/>
				</a>
			</div>
			<div class="download">
				<p class="block-title">클라이언트 설치 안내</p>
				<a href="/downfiles/client/ASO_KOREALOGIS.exe">
			...
			<div class="guide-wrap">
				...
				<div class="complete-wrap">
					...
					<p>
						<a href=" https://www.secudog.com/secudog/index.do" target="_blank"> 
							<img src="images/link_btn.png" alt=""/>
						</a>
					</p>
				</div>
