 ...
 * Generated at: 2021-10-06 02:18:33 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.search.agent.user_005flog;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/search/agent/user_log/listbody.jsp", Long.valueOf(1623113791000L));
    ...
    _jspx_dependants.put("/search/agent/user_log/userlog-dialog.jsp", Long.valueOf(1623113791000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">사용자 로그</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\topenUserLogInfoDialog = function(seqNo) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestUserLogInfoParam(seqNo);\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\turl: \"/CommandService\",\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자 로그 정보 조회\", \"사용자 로그 정보 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      ...
      out.write("\t\t\t\t\t\tresizeDialogElement($(this), $(this).find('#logdata'));\r\n");
      out.write("\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar logData = $(data).find('logdata').text();\r\n");
      out.write("\t\t\t\tlogData = logData.replace(/\\n/g, \"<br />\");\r\n");
      out.write("\t\t\t\tlogData = logData.replace(/\\t/g, \"&nbsp;&nbsp;\");\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar dialogContents = \"\";\r\n");
      out.write("\t\t\t\tdialogContents = '<div title=\"사용자 로그 정보\" class=\"dialog-form\">';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-logtype\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">로그 유형</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"logtype\">' + g_htLogTypeList.get($(data).find('logtype').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-logdata\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">로그 내용</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-contents\"><div id=\"logdata\" style=\"width: 98%; height: 120px; overflow: auto; white-space: normal;\">' + logData + '</div></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"clear\"></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-createdatetime\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">로그 일시</div>';\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자 로그 정보 조회\", \"사용자 로그 정보 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\tvar g_objUserLogList;\r\n");
      out.write("\r\n");
      out.write("\tvar g_htLogTypeList = new Hashtable();\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objUserLogList = $('#userlog-list');\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tg_htLogTypeList = loadTypeList(\"USER_LOG_TYPE\");\r\n");
      out.write("\t\tif (g_htLogTypeList.isEmpty()) {\r\n");
      out.write("\t\t\tdisplayAlertDialog(\"사용자 로그 유형 조회\", \"사용자 로그 유형 조회 중 오류가 발생하였습니다.\", \"자세한 사항은 시스템 관리자에게 문의해 주십시오.\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objUserLogList.find('#search-condition').find('select[name=\"searchlogtype\"]'), g_htLogTypeList, null, \"전체\");\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\tloadUserLogList();\r\n");
      out.write("\t\t\t} else if ($(this).attr('id') == 'btnDownload') {\r\n");
      out.write("\t\t\t\tdownloadUserLogList();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(document).on(\"click\", \".list-table tbody tr\", function() { if (typeof $(this).attr('seqno') != typeof undefined) { openUserLogInfoDialog($(this).attr('seqno')); } });\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadUserLogList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objUserLogList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objUserLogList.find('#search-result');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchLogType = objSearchCondition.find('select[name=\"searchlogtype\"]');\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestUserLogListParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\ttargetUserId,\r\n");
      out.write("\t\t\t\tobjSearchLogType.val(),\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자 로그 목록 조회\", \"사용자 로그 목록 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">로그 유형</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">로그 일시</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar logType = $(this).find('logtype').text();\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htLogTypeList.get(logType) + '</td>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"5\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자 로그가 존재하지 않습니다.</div></td>';\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"4\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자 로그가 존재하지 않습니다.</div></td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 사용자 로그 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사용자 로그 목록');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'dept') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('부서 사용자 로그 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'user') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사용자 로그 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사용자 로그 목록');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objUserLogList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자 로그 목록 조회\", \"사용자 로그 목록 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadUserLogList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objUserLogList.find('#search-condition');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchLogType = objSearchCondition.find('select[name=\"searchlogtype\"]');\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateUserLogListFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\ttargetUserId,\r\n");
      out.write("\t\t\t\tobjSearchLogType.val(),\r\n");
      ...
      out.write("\t\t\t\tg_searchListOrderByDirection);\r\n");
      out.write("\r\n");
      out.write("\t\tvar downloadFileName = \"사용자 로그 목록\";\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\topenDownloadDialog(\"사용자 로그 목록\", downloadFileName, postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">사용자 로그 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"userlog-list\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\" class=\"inline-search-condition\">\r\n");
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>로그 유형\r\n");
      out.write("\t\t\t\t<select id=\"searchlogtype\" name=\"searchlogtype\" class=\"ui-widget-content\"></select>\r\n");
