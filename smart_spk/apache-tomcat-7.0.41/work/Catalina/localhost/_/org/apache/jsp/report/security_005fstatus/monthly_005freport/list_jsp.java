 ...
 * Generated at: 2021-10-19 02:24:59 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.report.security_005fstatus.monthly_005freport;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/report/security_status/monthly_report/listbody.jsp", Long.valueOf(1623113791000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">보안정책 현황</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">월별 보안정책 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\tvar g_objMonthlyReportList;\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objMonthlyReportList = $('#monthlyreport-list');\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tg_objMonthlyReportList.find('#searchmonth').MonthPicker({\r\n");
      out.write("\t\t\tButton: false,\r\n");
      out.write("\t\t\tMonthFormat: 'yy-mm',\r\n");
      out.write("\t\t\tMaxMonth: -1,\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\t\tloadMonthlyReportList();\r\n");
 } 
      out.write("\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadMonthlyReportList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objMonthlyReportList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objMonthlyReportList.find('#search-result');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchSearchId = objSearchCondition.find('input[name=\"searchsearchid\"]');\r\n");
      out.write("\t\tvar objSearchMonth = objSearchCondition.find('input[name=\"searchmonth\"]');\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestMonthlyReportListParam(targetCompanyId,\r\n");
      out.write("\t\t\t\tobjSearchMonth.val(),\r\n");
      out.write("\t\t\t\tg_searchListOrderByName,\r\n");
      out.write("\t\t\t\tg_searchListOrderByDirection,\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"리포트 목록 조회\", \"리포트 목록 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"REPORTNAME\" class=\"ui-state-default\">리포트 명</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"15%\" id=\"REPORTMONTH\" class=\"ui-state-default\">리포트 대상 기간</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"15%\" id=\"CREATEDATETIME\" class=\"ui-state-default\">리포트 생성 일시</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"15%\" class=\"ui-state-default\">&nbsp</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar reportMonth = $(this).find('reportmonth').text();\r\n");
      out.write("\t\t\t\t\t\tvar reportName = $(this).find('reportname').text();\r\n");
      out.write("\t\t\t\t\t\tvar downloadPath = $(this).find('downloadpath').text();\r\n");
      out.write("\t\t\t\t\t\tvar createDateTime = $(this).find('createdatetime').text();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<tr downloadpath=\"' + downloadPath + '\" reportname=\"' + reportName + '\" class=\"' + lineStyle + '\">';\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + companyName + '</td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + reportName + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align:center;\">' + reportMonth + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align:center;\">' + createDateTime + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align:center;\"><button type=\"button\" id=\"btnDownload\" name=\"btnDownload\" onClick=\"downloadReport(this);\" class=\"small-button\">리포트 다운로드</button></td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tbody>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"5\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 리포트 목록이 존재하지 않습니다.</div></td>';\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"4\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 리포트 목록이 존재하지 않습니다.</div></td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 리포트 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 리포트 목록');\r\n");
      out.write("\t\t\t\t}\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t$('.inner-center .pane-header').text('리포트 목록');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\tg_objMonthlyReportList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"리포트 목록 조회\", \"리포트 목록 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadReport = function(obj) {\r\n");
      out.write("\t\tvar reportName = $(obj).closest('tr').attr('reportname');\r\n");
      out.write("\t\tvar downloadPath = $(obj).closest('tr').attr('downloadpath');\r\n");
      out.write("\t\twindow.location.href = \"/include/download.jsp?savefilename=\" + reportName + \".xlsx&filepath=\" + encodeURIComponent(downloadPath) + \"&filedeleteafterdownload=false\";\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 리포트 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"monthlyreport-list\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\" class=\"inline-search-condition\">\r\n");
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>조회 월\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"searchmonth\" name=\"searchmonth\" class=\"text ui-widget-content input-month\" readonly=\"readonly\" />\r\n");
