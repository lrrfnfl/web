 ...
 * Generated at: 2021-10-19 02:05:50 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.manage.software.software_005finstallation;
...
public final class softwareinstallationpersoftwarelist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/software/software_installation/softwareinstallation-dialog.jsp", Long.valueOf(1623113790000L));
    _jspx_dependants.put("/manage/software/software_installation/softwareinstallationpersoftwarelistbody.jsp", Long.valueOf(1623113790000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">소프트웨어 관리</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"parent-path\">소프트웨어 설치</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">소프트웨어별 설치 목록</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\topenSoftwareInstallationInfoDialog = function(seqNo) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestSoftwareInstallationInfoParam(seqNo);\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\turl: \"/CommandService\",\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"소프트웨어 설치 정보 조회\", \"소프트웨어 설치 정보 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      ...
      out.write("\t\t\t\t\t\tresizeDialogElement($(this), $(this).find('#description'));\r\n");
      out.write("\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\tdialogContents = '<div title=\"소프트웨어 설치 정보\" class=\"dialog-form\">';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-softwarename\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">소프트웨어 명</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"softwarename\">' + $(data).find('softwarename').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-version\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">버전</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"version\">' + $(data).find('version').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div id=\"row-filename\" class=\"field-line\">';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div class=\"field-title\">파일 명</div>';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"filename\">' + $(data).find('filename').text() + '</span></div>';\r\n");
      out.write("// \t\t\t\tdialogContents += '</div>';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div id=\"row-filesize\" class=\"field-line\">';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div class=\"field-title\">파일 크기</div>';\r\n");
      out.write("// \t\t\t\tif (($(data).find('filesize').text() != null) && $(data).find('filesize').text().length > 0) {\r\n");
      out.write("// \t\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"filesize\">' + $(data).find('filesize').text().replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + '</span></div>';\r\n");
      out.write("// \t\t\t\t} else {\r\n");
      out.write("// \t\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"filesize\">&nbsp;</span></div>';\r\n");
      out.write("// \t\t\t\t}\r\n");
      out.write("// \t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-description\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">설명</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-contents\"><div id=\"description\" style=\"width: 98%; height: 120px; overflow: auto; white-space: normal;\">' + $(data).find('description').text() + '</div></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"clear\"></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-vendor\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">공급사</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"vendor\">' + $(data).find('vendor').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div id=\"row-installedpath\" class=\"field-line\">';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div class=\"field-title\">설치 경로</div>';\r\n");
      out.write("// \t\t\t\tdialogContents += '<div class=\"field-value\" title=\"' + $(data).find('installedpath').text() + '\"><span id=\"installedpath\">' + $(data).find('installedpath').text() + '</span></div>';\r\n");
      out.write("// \t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-installeddate\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">설치 일자</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"installeddate\">' + $(data).find('installeddate').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"소프트웨어 설치 정보 조회\", \"소프트웨어 설치 정보 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("<!--\r\n");
      out.write("\tvar g_objSoftwareInstallationTree;\r\n");
      out.write("\tvar g_objSoftwareInstallationList;\r\n");
      out.write("\r\n");
      ...
      out.write("\t$(document).ready(function() {\r\n");
      out.write("\r\n");
      out.write("\t\tg_objSoftwareInstallationTree = $('#softwareinstallation-tree');\r\n");
      out.write("\t\tg_objSoftwareInstallationList = $('#softwareinstallation-list');\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objSoftwareInstallationList.find('#search-condition').find('select[name=\"searchdept\"]'), null, null, \"전체\");\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\tvar htDeptList = new Hashtable();\r\n");
      out.write("\t\thtDeptList = loadDeptList(\"");
      out.print((String)session.getAttribute("COMPANYID"));
      out.write("\");\r\n");
      out.write("\t\tfillDropdownList(g_objSoftwareInstallationList.find('select[name=\"searchdept\"]'), htDeptList, null, \"전체\");\r\n");
 } 
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tinnerDefaultLayout.show(\"west\");\r\n");
      out.write("\t\tloadSoftwareInstallationTreeView();\r\n");
      out.write("\r\n");
      out.write("\t\t$('button').click( function () {\r\n");
      out.write("\t\t\tif ($(this).attr('id') == 'btnSearch') {\r\n");
      out.write("\t\t\t\tg_searchListPageNo = 1;\r\n");
      out.write("\t\t\t\tloadSoftwareInstallationList();\r\n");
      out.write("\t\t\t} else if ($(this).attr('id') == 'btnDownload') {\r\n");
      out.write("\t\t\t\tdownloadSoftwareInstallationList();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(document).on(\"click\", \".list-table tbody tr\", function() { if (typeof $(this).attr('seqno') != typeof undefined) { openSoftwareInstallationInfoDialog($(this).attr('seqno')); } });\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
      ...
      out.print(TreeViewType.TREE_VIEW_TYPE_SOFTWARE_INSTALLATION);
      out.write("', '', companyId);\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype: \"POST\",\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadSoftwareInstallationTreeView = function() {\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tg_objSoftwareInstallationTree.jstree({\r\n");
      out.write("\t\t\t\"xml_data\" : {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar postData = getRequestSoftwareInstallationTreeNodesParam(node.attr('companyid'));\r\n");
      out.write("\t\t\t\t\t\t\t\treturn {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tsendmsg : postData\r\n");
      out.write("\t\t\t\t\t\t\t\t};\r\n");
      out.write("\t\t\t\t\t\t\t} else {\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\tvar postData = getRequestSoftwareInstallationTreeNodesParam('");
      out.print((String)session.getAttribute("COMPANYID"));
      out.write("');\r\n");
 } 
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\"success\": function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\t\t\tdisplayAlertDialog(\"소프트웨어 설치 구성도 조회\", \"소프트웨어 설치 구성도 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\tvar startTag = \"<root>\";\r\n");
      out.write("\t\t\t\t\t\t\tvar endTag = \"</root>\";\r\n");
      ...
      out.write("\t\t\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\t\t\tdisplayAlertDialog(\"소프트웨어 설치 구성도 조회\", \"소프트웨어 설치 구성도 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t},\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t\t\t\tvar htDeptList = new Hashtable();\r\n");
      out.write("\t\t\t\t\thtDeptList = loadDeptList(data.rslt.obj.attr('companyid'));\r\n");
      out.write("\t\t\t\t\tfillDropdownList(g_objSoftwareInstallationList.find('select[name=\"searchdept\"]'), htDeptList, null, \"전체\");\r\n");
      out.write("\t\t\t\t\tg_objSoftwareInstallationList.find('#search-condition').find('#row-searchdept').show();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\tfillDropdownList(g_objSoftwareInstallationList.find('select[name=\"searchdept\"]'), null, null, \"전체\");\r\n");
      out.write("\t\t\t\tg_objSoftwareInstallationList.find('#search-condition').find('#row-searchdept').hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadSoftwareInstallationList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objSoftwareInstallationList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objSoftwareInstallationList.find('#search-result');\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tvar objTreeReference = $.jstree._reference(g_objSoftwareInstallationTree);\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tif (objSearchDept.val().length > 0)\r\n");
      out.write("\t\t\tarrTargetDeptList.push(objSearchDept.val());\r\n");
      out.write("\r\n");
      out.write("\t\tvar targetSoftwareName = \"\";\r\n");
      out.write("\t\tif (objTreeReference.get_selected().attr(\"node_type\") == 'software') {\r\n");
      out.write("\t\t\ttargetSoftwareName = objTreeReference.get_text(objTreeReference.get_selected()); \r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tif (typeof objTreeReference.get_selected().attr('softwarename') != typeof undefined) {\r\n");
      out.write("\t\t\ttargetSoftwareName = objTreeReference.get_selected().attr('softwarename');\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestSoftwareInstallationListParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\t\"\",\r\n");
      out.write("\t\t\t\ttargetSoftwareName,\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"소프트웨어 설치 목록 조회\", \"소프트웨어 설치 목록 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\thtmlContents += '<th id=\"SOFTWARENAME\" class=\"ui-state-default\">소프트웨어 명</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"12%\" id=\"VERSION\" class=\"ui-state-default\">버전</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"15%\" id=\"VENDOR\" class=\"ui-state-default\">공급사</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"80\" id=\"INSTALLEDDATE\" class=\"ui-state-default\">설치 일자</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar softwarename = $(this).find('softwarename').text();\r\n");
      out.write("\t\t\t\t\t\tvar version = $(this).find('version').text();\r\n");
      out.write("\t\t\t\t\t\tvar vendor = $(this).find('vendor').text();\r\n");
      out.write("\t\t\t\t\t\tvar installedDate = $(this).find('installeddate').text();\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: left;\" title=\"' + softwarename + '\">' + softwarename + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + version + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: left;\">' + vendor + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + installedDate + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tbody>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"7\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 소프트웨어 설치 목록이 존재하지 않습니다.</div></td>';\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"6\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 소프트웨어 설치 목록이 존재하지 않습니다.</div></td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 소프트웨어 설치 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 소프트웨어 설치 목록');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'software') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('소프트웨어 설치 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 소프트웨어 설치 목록');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objSoftwareInstallationList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"소프트웨어 설치 목록 조회\", \"소프트웨어 설치 목록 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadSoftwareInstallationList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objSoftwareInstallationList.find('#search-condition');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchDept = objSearchCondition.find('select[name=\"searchdept\"]');\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateSoftwareInstallationListFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\t\"\",\r\n");
      out.write("\t\t\t\ttargetSoftwareName,\r\n");
      ...
      out.write("\t\t\t\tg_searchListOrderByDirection);\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"소프트웨어 설치 목록\", \"소프트웨어 설치 목록\", postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<div class=\"inner-west\">\r\n");
      out.write("\t<div class=\"pane-header\">소프트웨어 설치 구성도</div>\r\n");
      out.write("\t<div class=\"ui-layout-content zero-padding\">\r\n");
      out.write("\t\t<div id=\"softwareinstallation-tree\" class=\"treeview-pannel\"></div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"inner-center\">\r\n");
      out.write("\t<div class=\"pane-header\">전체 소프트웨어 설치 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"softwareinstallation-list\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\" class=\"inline-search-condition\">\r\n");
      out.write("\t\t\t\t<div id=\"row-searchdept\" style=\"display: inline-block;\"> \r\n");
