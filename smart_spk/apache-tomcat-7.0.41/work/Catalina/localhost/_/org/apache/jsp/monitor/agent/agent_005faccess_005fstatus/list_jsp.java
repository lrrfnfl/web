 ...
 * Generated at: 2021-10-06 00:24:38 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.monitor.agent.agent_005faccess_005fstatus;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/monitor/agent/agent_access_status/listbody.jsp", Long.valueOf(1623113790000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"current-path\">접속 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\tvar g_objAgentMonitorList;\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objAgentMonitorList = $('#agentmonitor-list');\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objAgentMonitorList.find('#search-condition').find('select[name=\"searchinstallflag\"]'), g_htInstallStateList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentMonitorList.find('#search-condition').find('select[name=\"searchservicestate\"]'), g_htServiceStateList, null, \"전체\");\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\tloadAgentMonitorList();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadAgentMonitorList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objAgentMonitorList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objAgentMonitorList.find('#search-result');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestAgentMonitorListParam(targetCompanyId,\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자 접속 현황 목록 조회\", \"사용자 접속 현황 목록 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\thtmlContents += '<th width=\"80\" id=\"INSTALLFLAG\" class=\"ui-state-default\">설치 상태</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"80\" id=\"SERVICESTATEFLAG\" class=\"ui-state-default\">서비스 상태</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"125\" id=\"LASTLOGINDATETIME\" class=\"ui-state-default\">최종 로그인 일시</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"125\" id=\"ELAPSEDSECONDS\" class=\"ui-state-default\">종료 후 경과시간</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"90\" id=\"SERVICESTATEFLAG\" class=\"ui-state-default\">클라이언트 상태</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar loginFlag = $(this).find('loginflag').text();\r\n");
      ...
      out.write("\t\t\t\t\t\tvar elapsedSeconds = $(this).find('elapsedseconds').text();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\tif (lastLoginDatetime.length == 0) {\r\n");
      out.write("\t\t\t\t\t\t\tlastLoginDatetime = \"\";\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\tvar elapsedTime = \"\";\r\n");
      out.write("\t\t\t\t\t\tvar agentStatus = \"\";\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\tif (installFlag == '");
      out.print(InstallState.INSTALL_STATE_INSTALL);
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\tif (elapsedSeconds.length != 0) {\r\n");
      out.write("\t\t\t\t\t\t\t\tif (parseInt(elapsedSeconds) > ");
      out.print(CommonConstant.AGENT_CHECK_TIME_LIMIT);
      out.write(" + 1) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tagentStatus = \"종료\";\r\n");
      out.write("\t\t\t\t\t\t\t\t\telapsedTime = getElapsedTimeString(elapsedSeconds);\r\n");
      out.write("\t\t\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t\t\tagentStatus = \"실행중\";\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + elapsedTime + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: center;\">' + agentStatus + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tbody>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"8\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자 접속 현황이 존재하지 않습니다.</div></td>';\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"7\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자 접속 현황이 존재하지 않습니다.</div></td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 사용자 접속 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사용자 접속 현황');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'dept') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('부서 사용자 접속 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 사용자 접속 현황');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objAgentMonitorList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자 접속 현황 목록 조회\", \"사용자 접속 현황 목록 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tgetElapsedTimeString = function(elapsedSeconds) {\r\n");
      out.write("\t\tvar elapsedTime = \"\";\r\n");
      out.write("\r\n");
      out.write("\t\tif (elapsedSeconds.length == 0) {\r\n");
      out.write("\t\t\telapsedTime = \"-\";\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\tif (parseInt(elapsedSeconds)/3600 > 1) {\r\n");
      out.write("\t\t\t\telapsedTime += parseInt(parseInt(elapsedSeconds)/3600).toString().replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + '시간 ';\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif (parseInt(elapsedSeconds)/60 > 1) {\r\n");
      out.write("\t\t\t\telapsedTime += parseInt(parseInt(elapsedSeconds)%3600/60) + '분 ';\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\telapsedTime += parseInt(elapsedSeconds)%60 + '초';\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\treturn elapsedTime;\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 사업장 사용자 접속 현황 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"agentmonitor-list\" style=\"display: none;\">\r\n");
