 ...
 * Generated at: 2021-10-13 00:07:28 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.statistics.privacy.detect_005fstatus_005fper_005fterms;
...
public final class status_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/statistics/privacy/detect_status_per_terms/statusbody.jsp", Long.valueOf(1623113793000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">검출 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('사업장 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('전체 검출 현황');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t} else if (data.rslt.obj.attr('node_type') == \"dept\") {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('부서 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t\t} else if (data.rslt.obj.attr('node_type') == \"user\") {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('사용자 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 검출 현황');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDetectStatusPerTermsParam(\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"기간별 검출 현황 조회\", \"기간별 검출 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"기간별 검출 현황 조회\", \"기간별 검출 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY)\r\n");
      out.write("\t\t\thtmlContents += '<th width=\"70\" class=\"ui-state-default\">검출일자</th>';\r\n");
      out.write("\t\telse if (g_selectedTabIndex == TAB_MONTHLY)\r\n");
      out.write("\t\t\thtmlContents += '<th width=\"70\" class=\"ui-state-default\">검출년월</th>';\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY)\r\n");
      out.write("\t\t\t$('#daily-pie-chart-table').html(htmlContents);\r\n");
      out.write("\t\telse if (g_selectedTabIndex == TAB_MONTHLY)\r\n");
      out.write("\t\t\t$('#monthly-pie-chart-table').html(htmlContents);\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateDetectStatusPerTermsFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\ttargetUserId,\r\n");
      out.write("\t\t\t\ttermType,\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 사업장 검출 현황</div>\r\n");
      out.write("\t<ul>\r\n");
      out.write("\t\t<li><a href=\"#tab-daily\">일별 검출 현황</a></li>\r\n");
      out.write("\t\t<li><a href=\"#tab-monthly\">월별 검출 현황</a></li>\r\n");
      out.write("\t</ul>\r\n");
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"margin-left: 51%;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"daily-pie-chart-table\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"margin-left: 51%;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"monthly-pie-chart-table\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
