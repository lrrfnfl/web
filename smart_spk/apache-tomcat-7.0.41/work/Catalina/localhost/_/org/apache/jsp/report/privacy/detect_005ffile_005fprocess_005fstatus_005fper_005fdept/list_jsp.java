 ...
 * Generated at: 2021-10-13 02:03:10 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.report.privacy.detect_005ffile_005fprocess_005fstatus_005fper_005fdept;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/report/privacy/detect_file_process_status_per_dept/listbody.jsp", Long.valueOf(1623113790000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">부서별 처리 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\tvar g_objDetectFileProcessStatusPerDeptList;\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objDetectFileProcessStatusPerDeptList = $('#detectfileprocessstatusperdept-list');\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\t\tloadDetectFileProcessStatusPerDeptList();\r\n");
 } 
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t$('button').click( function () {\r\n");
      out.write("\t\t\tif ($(this).attr('id') == 'btnDownload') {\r\n");
      out.write("\t\t\t\tdownloadDetectFileProcessStatusPerDeptList();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(document).on(\"click\", \".list-table th\", function () { if (typeof $(this).attr('id') != typeof undefined) { g_searchListOrderByName = $(this).attr('id'); if (g_searchListOrderByDirection == 'ASC') { g_searchListOrderByDirection = 'DESC'; } else { g_searchListOrderByDirection = 'ASC'; }; g_searchListPageNo = 1; loadDetectFileProcessStatusPerDeptList(); }; });\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadDetectFileProcessStatusPerDeptList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchResult = g_objDetectFileProcessStatusPerDeptList.find('#search-result');\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDetectFileProcessStatusPerDeptListParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tg_searchListOrderByName,\r\n");
      out.write("\t\t\t\tg_searchListOrderByDirection,\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"부서별 검출 파일 처리 현황 조회\", \"부서별 검출 파일 처리 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"USERCOUNT\" class=\"ui-state-default\">사용자수</th>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\thtmlContents += '<th id=\"USERCOUNT\" class=\"ui-state-default\">사용자 수</th>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\tif (oemName == \"MOCOMSYS\") {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"10\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 부서별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"7\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 부서별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t}\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\tif (oemName == \"MOCOMSYS\") {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"9\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 부서별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"6\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 부서별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t}\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 부서별 검출 파일 처리 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 부서별 검출 파일 처리 현황');\r\n");
      out.write("\t\t\t\t}\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t$('.inner-center .pane-header').text('부서별 검출 파일 처리 현황');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\tg_objDetectFileProcessStatusPerDeptList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"부서별 검출 파일 처리 현황 조회\", \"부서별 검출 파일 처리 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadDetectFileProcessStatusPerDeptList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar targetCompanyId = \"\";\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateDetectFileProcessStatusPerDeptListFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tg_searchListOrderByName,\r\n");
      out.write("\t\t\t\tg_searchListOrderByDirection);\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"부서별 검출 파일 처리 현황\", \"부서별 검출 파일 처리 현황\", postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 사업장 부서별 검출 파일 처리 현황</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"detectfileprocessstatusperdept-list\" style=\"display: none;\">\r\n");
