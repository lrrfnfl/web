 ...
 * Generated at: 2021-10-06 00:30:02 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.search.privacy.detect_005flog;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/search/privacy/detect_log/detectlog-dialog.jsp", Long.valueOf(1623113791000L));
    _jspx_dependants.put("/top.jsp", Long.valueOf(1625118829000L));
    _jspx_dependants.put("/search/privacy/detect_log/listbody.jsp", Long.valueOf(1623113791000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">검출</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">검출 목록</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("<style>\r\n");
      out.write("\t#tab-detectloginfo > .ui-widget-header { \r\n");
      ...
      out.write("\r\n");
      out.write("\topenDetectLogInfoDialog = function(seqNo) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDetectLogInfoParam(seqNo);\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\turl: \"/CommandService\",\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"검출 정보 조회\", \"검출 정보 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      ...
      out.write("\t\t\t\t\t\t\tresizeDialogElement($(this), $(this).find('#detectinfo'));\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar detectPatternCount = $(data).find('detectpatterncount').text();\r\n");
      out.write("\t\t\t\tvar totalDetectKeywordCount = $(data).find('totaldetectkeywordcount').text();\r\n");
      out.write("\t\t\t\tif (detectPatternCount.length == 0)\r\n");
      out.write("\t\t\t\t\tdetectPatternCount = 0;\r\n");
      out.write("\t\t\t\tif (totalDetectKeywordCount.length == 0)\r\n");
      out.write("\t\t\t\t\ttotalDetectKeywordCount = 0;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar dialogContents = \"\";\r\n");
      out.write("\t\t\t\tdialogContents = '<div title=\"검출 정보\" class=\"dialog-form\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"dialog-contents\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"tab-detectloginfo\" class=\"styles-tab\" style=\"border: none;\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<ul>';\r\n");
      out.write("\t\t\t\tdialogContents += '<li><a href=\"#tab-detectinfo\">검출 정보</a></li>';\r\n");
      out.write("\t\t\t\tdialogContents += '<li><a href=\"#tab-detectdetailinfo\">검출 상세 정보</a></li>';\r\n");
      out.write("\t\t\t\tdialogContents += '</ul>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"tab-detectinfo\" style=\"padding: 8px 2px 0 2px;\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"detectinfo\">';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-searchid\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">검사 ID</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"searchid\">' + $(data).find('searchid').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-searchtype\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">검사 유형</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"searchtype\">' + g_htSearchTypeList.get($(data).find('searchtype').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-searchdate\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">검사 일자</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"searchdate\">' + $(data).find('searchdate').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-detectstatus\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">검출 상태</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"detectstatus\">' + g_htDetectStateList.get($(data).find('detectstatus').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-resultstate\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">처리 상태</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"resultstate\">' + g_htResultStateList.get($(data).find('result').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-detectpatterncount\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">검출 패턴 유형</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"detectpatterncount\">' + detectPatternCount.toString().replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + '</span> 패턴</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-totaldetectkeywordcount\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">검출 패턴 수</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"totaldetectkeywordcount\">' + totalDetectKeywordCount.toString().replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + '</span> 건</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-ipaddress\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">클라이언트 주소</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"ipaddress\">' + $(data).find('ipaddress').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"tab-detectdetailinfo\" style=\"padding: 8px 2px 0 2px;\">';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '<th width=\"40%\">패턴 대분류 명</th>';\r\n");
      out.write("\t\t\t\tdialogContents += '<th width=\"40%\">패턴 소분류 명</th>';\r\n");
      ...
      out.write("\t\t\t\t\t\tdialogContents += '<td>' + patternCategoryName + '</td>';\r\n");
      out.write("\t\t\t\t\t\tdialogContents += '<td>' + patternName + '</td>';\r\n");
      ...
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\tdialogContents += '<tr>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<td colspan=\"3\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">검출된 패턴 내용이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '</tr>';\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tdialogContents += '</tbody>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '</table>';\r\n");
      ...
      out.write("\t\t\t\t\theight: newDialog.find('#tab-detectinfo').height() - 26\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tnewDialog.find('#tab-detectloginfo').tabs({\r\n");
      out.write("\t\t\t\t\theightStyle: \"content\",\r\n");
      out.write("\t\t\t\t\tactive: 0,\r\n");
      out.write("\t\t\t\t\tactivate: function(event, ui) {\r\n");
      out.write("\t\t\t\t\t\tg_selectedDialogTabIndex = ui.newTab.index();\r\n");
      out.write("\t\t\t\t\t\tif (g_selectedDialogTabIndex == 0) {\r\n");
      out.write("\t\t\t\t\t\t\tresizeDialogElement(newDialog, newDialog.find('#detectinfo'));\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"검출 정보 조회\", \"검출 정보 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\t\tg_objDetectLogList = $('#detectlog-list');\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tg_htDetectStateList = loadTypeList(\"DETECT_STATE\");\r\n");
      out.write("\t\tif (g_htDetectStateList.isEmpty()) {\r\n");
      out.write("\t\t\tdisplayAlertDialog(\"검출 상태 유형 조회\", \"검출 상태 유형 조회 중 오류가 발생하였습니다.\", \"자세한 사항은 시스템 관리자에게 문의해 주십시오.\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objDetectLogList.find('#search-condition').find('select[name=\"searchusertype\"]'), g_htUserTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objDetectLogList.find('#search-condition').find('select[name=\"searchsearchtype\"]'), g_htSearchTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objDetectLogList.find('#search-condition').find('select[name=\"searchdetectstatus\"]'), g_htDetectStateList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objDetectLogList.find('#search-condition').find('select[name=\"searchresultstate\"]'), g_htResultStateList, null, \"전체\");\r\n");
      out.write("\t\t//g_objDetectLogList.find('#search-condition').find('select[name=\"searchresultstate\"]').find('[value=\"' + ");
      ...
      out.write("\t\t\t\tloadDetectLogList();\r\n");
      out.write("\t\t\t} else if ($(this).attr('id') == 'btnDownload') {\r\n");
      out.write("\t\t\t\tdownloadDetectLogList();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(document).on(\"click\", \".list-table tbody tr\", function() { if (typeof $(this).attr('seqno') != typeof undefined) { openDetectLogInfoDialog($(this).attr('seqno')); } });\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadDetectLogList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objDetectLogList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objDetectLogList.find('#search-result');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tvar objSearchDetectStatus = objSearchCondition.find('select[name=\"searchdetectstatus\"]');\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"검출 목록 조회\", \"검출 목록 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\thtmlContents += '<th width=\"65\" class=\"ui-state-default\">사용자 유형</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"65\" class=\"ui-state-default\">검사 유형</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"70\" class=\"ui-state-default\">검사일</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<td class=\"ui-state-default\">검출 파일</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th width=\"50\" class=\"ui-state-default\">검출 상태</th>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar searchType = $(this).find('searchtype').text();\r\n");
      out.write("\t\t\t\t\t\tvar searchId = $(this).find('searchid').text();\r\n");
      out.write("\t\t\t\t\t\tvar searchDate = $(this).find('searchdate').text();\r\n");
      ...
      out.write("\t\t\t\t\t\tvar detectStatus = $(this).find('detectstatus').text();\r\n");
      out.write("\t\t\t\t\t\tvar result = $(this).find('result').text();\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align:center;\">' + g_htSearchTypeList.get(searchType) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align:center;\">' + searchDate + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td title=\"' + searchPath + '\">' + searchFileName + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align:center;\">' + g_htDetectStateList.get(detectStatus) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align:center;\">' + g_htResultStateList.get(result) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tbody>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"9\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 검출 목록이 존재하지 않습니다.</div></td>';\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"8\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 검출 목록이 존재하지 않습니다.</div></td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 검출 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 검출 목록');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'dept') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('부서 검출 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'user') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사용자 검출 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 검출 목록');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objDetectLogList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"검출 목록 조회\", \"검출 목록 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadDetectLogList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objDetectLogList.find('#search-condition');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchSearchId = objSearchCondition.find('input[name=\"searchsearchid\"]');\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateDetectLogListFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\ttargetUserId,\r\n");
      out.write("\t\t\t\tobjSearchSearchId.val(),\r\n");
      ...
      out.write("\t\t\t\tg_searchListOrderByDirection);\r\n");
      out.write("\r\n");
      out.write("\t\tvar downloadFileName = \"검출 목록\";\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\topenDownloadDialog(\"검출 목록\", downloadFileName, postData);\r\n");
      out.write("\t};\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 사업장 검출 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"detectlog-list\" style=\"display: none;\">\r\n");
      ...
      out.write("\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td class=\"ui-state-default\"><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>검사 ID</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" id=\"searchsearchid\" name=\"searchsearchid\" class=\"text ui-widget-content\" /></td>\r\n");
      out.write("\t\t\t\t\t<td class=\"ui-state-default\"><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>검사 유형</td>\r\n");
      out.write("\t\t\t\t\t<td><select id=\"searchsearchtype\" name=\"searchsearchtype\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t<td style=\"display: none;\" class=\"ui-state-default\"><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>사용자 유형</td>\r\n");
      out.write("\t\t\t\t\t<td style=\"display: none;\"><select id=\"searchusertype\" name=\"searchusertype\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td class=\"ui-state-default\"><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>검출 상태</td>\r\n");
      out.write("\t\t\t\t\t<td><select id=\"searchdetectstatus\" name=\"searchdetectstatus\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t<td class=\"ui-state-default\"><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>처리 상태</td>\r\n");
      out.write("\t\t\t\t\t<td><select id=\"searchresultstate\" name=\"searchresultstate\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t<td class=\"ui-state-default\"><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>조회 기간</td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      ...
      out.write("<!-- \t\t\t\t</div> -->\r\n");
      out.write("<!-- \t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>검출 상태 -->\r\n");
      out.write("<!-- \t\t\t\t<select id=\"searchdetectstatus\" name=\"searchdetectstatus\" class=\"ui-widget-content\"></select> -->\r\n");
      ...
      out.write("<!-- \t\t\t\t<input type=\"text\" id=\"searchdatefrom\" name=\"searchdatefrom\" class=\"text ui-widget-content\" style=\"width: 80px; text-align: center;\" readonly=\"readonly\" /> -->\r\n");
      out.write("<!-- \t\t\t\t~<input type=\"text\" id=\"searchdateto\" name=\"searchdateto\" class=\"text ui-widget-content\" style=\"width: 80px; text-align: center;\" readonly=\"readonly\" /> -->\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("<!-- \t<div class=\"ui-state-default pane-footer\"> -->\r\n");
