 ...
 * Generated at: 2021-10-13 01:49:15 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.report.privacy.user_005fnot_005fexecuted_005fsearch;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/report/privacy/user_not_executed_search/listbody.jsp", Long.valueOf(1623113790000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">검사 현황</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">검사 미실행 사용자</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\tvar g_objUserNotExecutedSearchList;\r\n");
      out.write("\r\n");
      out.write("\tvar g_htServiceStateList = new Hashtable();\r\n");
      out.write("\r\n");
      out.write("\tvar g_selectedCompanyId = \"\";\r\n");
      out.write("\tvar g_selectedDeptCode = \"\";\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objUserNotExecutedSearchList = $('#usernotexecutedsearch-list');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objUserNotExecutedSearchList.find('#search-condition').find('input[name=\"searchdatefrom\"]').val(searchDateFrom.formatString(\"yyyy-MM-dd\"));\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t\t\tloadUserNotExecutedSearchList();\r\n");
      out.write("\t\t\t} else if ($(this).attr('id') == 'btnDownload') {\r\n");
      out.write("\t\t\t\tdownloadUserNotExecutedSearchList();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadUserNotExecutedSearchList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objUserNotExecutedSearchList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objUserNotExecutedSearchList.find('#search-result');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestUserNotExecutedSearchListParam(\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"검사 미실행 사용자 조회\", \"검사 미실행 사용자 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\thtmlContents += '<th id=\"LASTLOGINDATETIME\" class=\"ui-state-default\">최근 로그인 일시</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"LASTSEARCHDATETIME\" class=\"ui-state-default\">최근 검사 일시</th>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar lastLoginDatetime = $(this).find('lastlogindatetime').text();\r\n");
      out.write("\t\t\t\t\t\tvar lastSearchDatetime = $(this).find('lastsearchdatetime').text();\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: center;\">' + lastLoginDatetime + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: center;\">' + lastSearchDatetime + '</td>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"7\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 검사 미실행 사용자가 존재하지 않습니다.</div></td>';\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"6\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 검사 미실행 사용자가 존재하지 않습니다.</div></td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 검사 미실행 사용자 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 검사 미실행 사용자 목록');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'dept') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('부서 검사 미실행 사용자 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 검사 미실행 사용자 목록');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objUserNotExecutedSearchList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"검사 미실행 사용자 조회\", \"검사 미실행 사용자 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadUserNotExecutedSearchList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objUserNotExecutedSearchList.find('#search-condition');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchDateFrom = objSearchCondition.find('input[name=\"searchdatefrom\"]');\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateUserNotExecutedSearchListFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\tobjSearchDateFrom.val(),\r\n");
      out.write("\t\t\t\tg_searchListOrderByName,\r\n");
      out.write("\t\t\t\tg_searchListOrderByDirection);\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"검사 미실행 사용자 목록\", \"검사 미실행 사용자 목록\", postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 사업장 미실행 사용자 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"usernotexecutedsearch-list\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\" class=\"inline-search-condition\">\r\n");
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"searchdatefrom\" name=\"searchdatefrom\" class=\"text ui-widget-content input-date\" readonly=\"readonly\" /> 이후 미실행 사용자\r\n");
