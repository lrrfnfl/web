 ...
 * Generated at: 2021-10-06 01:12:03 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.config.agent.agent_005fconfig_005fstatus;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/config/agent/agent_config_status/listbody.jsp", Long.valueOf(1623113787000L));
    ...
    _jspx_dependants.put("/config/agent/agent_config_status/agentconfigstatus-dialog.jsp", Long.valueOf(1623113787000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">설정</span> -->\r\n");
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">에이전트 설정 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\tvar g_dialogHeight = ($(document).height()*3)/4;\r\n");
      out.write("\tvar g_lastDialogPosition;\r\n");
      out.write("\r\n");
      out.write("\topenAgentConfigStatusInfoDialog = function(companyId, userId) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestAgentConfigStatusInfoParam(companyId, userId);\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\turl: \"/CommandService\",\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"에이전트 설정 현황 정보 조회\", \"에이전트 설정 현황 정보 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\"maximize\" : function(event, ui) {\r\n");
      out.write("\t\t\t\t\t},\r\n");
      ...
      out.write("\t\t\t\tdialogContents = '<div title=\"에이전트 설정 현황 정보\" class=\"dialog-form\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"dialog-contents\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-sub-title\">사업장 정보</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-contents border-none\" style=\"padding: 5px 0;\">';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-sub-title\">기본 정책</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-contents border-none\" style=\"padding: 5px 0;\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-jobprocessingtype\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">검출파일 처리유형</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"jobprocessingtype\">' + g_htJobProcessingTypeList.get($(data).find('jobprocessingtype').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-forcedterminationflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">강제종료 차단</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"forcedterminationflag\">' + g_htOptionTypeList.get($(data).find('forcedterminationflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-decordingpermissionflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">복호화 허용</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"decordingpermissionflag\">' + g_htOptionTypeList.get($(data).find('decordingpermissionflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-contentcopypreventionflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">복사 방지</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"contentcopypreventionflag\">' + g_htOptionTypeList.get($(data).find('contentcopypreventionflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-realtimeobservationflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">실시간 감시</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"realtimeobservationflag\">' + g_htOptionTypeList.get($(data).find('realtimeobservationflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-passwordexpirationflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">비밀번호 유효기간 설정</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"passwordexpirationflag\">' + g_htOptionTypeList.get($(data).find('passwordexpirationflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tif ($(data).find('passwordexpirationflag').text() == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div id=\"row-passwordexpirationperiod\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-title\">비밀번호 유효기간</div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"passwordexpirationperiod\">' + $(data).find('passwordexpirationperiod').text().replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + '일</span></div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-sub-title\">워터마크</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-contents border-none\" style=\"padding: 5px 0;\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-wmprintmode\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">출력 모드</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"wmprintmode\">' + g_htPrintModeList.get($(data).find('wmprintmode').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-sub-title\">매체 제어</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-contents border-none\" style=\"padding: 5px 0;\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-usbcontrolflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">USB 제어</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"usbcontrolflag\">' + g_htOptionTypeList.get($(data).find('usbcontrolflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tif ($(data).find('usbcontrolflag').text() == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div id=\"row-usbcontroltype\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-title\">USB 제어 유형</div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"usbcontroltype\">' + g_htControlTypeList.get($(data).find('usbcontroltype').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-cdromcontrolflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">CD-ROM 제어</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"cdromcontrolflag\">' + g_htOptionTypeList.get($(data).find('cdromcontrolflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tif ($(data).find('cdromcontrolflag').text() == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div id=\"row-cdromcontroltype\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-title\">CD-ROM 제어 유형</div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"cdromcontroltype\">' + g_htControlTypeList.get($(data).find('cdromcontroltype').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-sub-title\">네트워크 서비스 제어</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-contents border-none\" style=\"padding: 5px 0;\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-networkservicecontrolflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">네트워크 서비스 제어</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"networkservicecontrolflag\">' + g_htOptionTypeList.get($(data).find('networkservicecontrolflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-sub-title\">시스템 제어</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"category-contents border-none\" style=\"padding: 5px 0;\">';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"systempasswordsetupflag\">' + g_htOptionTypeList.get($(data).find('systempasswordsetupflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-systempasswordexpirationflag\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">비밀번호 유효기간 설정</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"systempasswordexpirationflag\">' + g_htOptionTypeList.get($(data).find('systempasswordexpirationflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tif ($(data).find('systempasswordexpirationflag').text() == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div id=\"row-systempasswordexpirationperiod\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-title\">비밀번호 유효기간</div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"systempasswordexpirationperiod\">' + $(data).find('systempasswordexpirationperiod').text().replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + '일</span></div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"screensaveractivationflag\">' + g_htOptionTypeList.get($(data).find('screensaveractivationflag').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tif ($(data).find('screensaveractivationflag').text() == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div id=\"row-screensaverwaitingminutes\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-title\">활성화 대기 시간</div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"screensaverwaitingminutes\">' + $(data).find('screensaverwaitingminutes').text().replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + '분</span></div>';\r\n");
      out.write("\t\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"에이전트 설정 현황 정보 조회\", \"에이전트 설정 현황 정보 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\tvar g_objAgentConfigStatusList;\r\n");
      out.write("\r\n");
      out.write("\tvar g_htOptionTypeList = new Hashtable();\r\n");
      out.write("\tvar g_htOptionMarkList = new Hashtable();\r\n");
      ...
      out.write("\t\tg_objAgentConfigStatusList = $('#agentconfigstatus-list');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tg_htOptionMarkList = loadTypeList(\"OPTION_MARK\");\r\n");
      out.write("\t\tif (g_htOptionMarkList.isEmpty()) {\r\n");
      out.write("\t\t\tdisplayAlertDialog(\"옵션 마크 유형 조회\", \"옵션 마크 유형 조회 중 오류가 발생하였습니다.\", \"자세한 사항은 시스템 관리자에게 문의해 주십시오.\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchjobprocessingtype\"]'), g_htJobProcessingTypeList, null, \"전체\");\r\n");
      out.write("\t\tg_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchjobprocessingtype\"]').find('option[value=\"' + '");
      ...
      out.write("' + '\"]').remove();\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchforcedterminationflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchdecordingpermissionflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchcontentcopypreventionflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchrealtimeobservationflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchpasswordexpirationflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchwmprintmode\"]'), g_htPrintModeList, null, \"전체\");\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchusbcontrolflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchcdromcontrolflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchnetworkservicecontrolflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchsystempasswordsetupflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchsystempasswordexpirationflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\t\tfillDropdownList(g_objAgentConfigStatusList.find('#search-condition').find('select[name=\"searchscreensaveractivationflag\"]'), g_htOptionTypeList, null, \"전체\");\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\tloadAgentConfigStatusList();\r\n");
      out.write("\t\t\t} else if ($(this).attr('id') == 'btnDownload') {\r\n");
      out.write("\t\t\t\tdownloadConfigData();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(document).on(\"click\", \".list-table tbody tr\", function() { if (typeof $(this).attr('companyid') != typeof undefined) { openAgentConfigStatusInfoDialog($(this).attr('companyid'), $(this).attr('userid')); } });\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadAgentConfigStatusList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objAgentConfigStatusList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objAgentConfigStatusList.find('#search-result');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchJobProcessingType = objSearchCondition.find('select[name=\"searchjobprocessingtype\"]');\r\n");
      out.write("\t\tvar objSearchForcedTerminationFlag = objSearchCondition.find('select[name=\"searchforcedterminationflag\"]');\r\n");
      out.write("\t\tvar objSearchDecordingPermissionFlag = objSearchCondition.find('select[name=\"searchdecordingpermissionflag\"]');\r\n");
      out.write("\t\tvar objSearchContentCopyPreventionFlag = objSearchCondition.find('select[name=\"searchcontentcopypreventionflag\"]');\r\n");
      out.write("\t\tvar objSearchRealtimeObservationFlag = objSearchCondition.find('select[name=\"searchrealtimeobservationflag\"]');\r\n");
      out.write("\t\tvar objSearchPasswordExpirationFlag = objSearchCondition.find('select[name=\"searchpasswordexpirationflag\"]');\r\n");
      out.write("\t\tvar objSearchWmPrintMode = objSearchCondition.find('select[name=\"searchwmprintmode\"]');\r\n");
      out.write("\t\tvar objSearchUsbControlFlag = objSearchCondition.find('select[name=\"searchusbcontrolflag\"]');\r\n");
      out.write("\t\tvar objSearchCdromControlFlag = objSearchCondition.find('select[name=\"searchcdromcontrolflag\"]');\r\n");
      out.write("\t\tvar objSearchNetworkServiceControlFlag = objSearchCondition.find('select[name=\"searchnetworkservicecontrolflag\"]');\r\n");
      out.write("\t\tvar objSearchSystemPasswordSetupFlag = objSearchCondition.find('select[name=\"searchsystempasswordsetupflag\"]');\r\n");
      out.write("\t\tvar objSearchSystemPasswordExpirationFlag = objSearchCondition.find('select[name=\"searchsystempasswordexpirationflag\"]');\r\n");
      out.write("\t\tvar objSearchScreenSaverActivationFlag = objSearchCondition.find('select[name=\"searchscreensaveractivationflag\"]');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestAgentConfigStatusListParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\ttargetUserId,\r\n");
      out.write("\t\t\t\tobjSearchJobProcessingType.val(),\r\n");
      out.write("\t\t\t\tobjSearchForcedTerminationFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchDecordingPermissionFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchContentCopyPreventionFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchRealtimeObservationFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchPasswordExpirationFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchWmPrintMode.val(),\r\n");
      out.write("\t\t\t\tobjSearchUsbControlFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchCdromControlFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchNetworkServiceControlFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchSystemPasswordSetupFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchSystemPasswordExpirationFlag.val(),\r\n");
      out.write("\t\t\t\tobjSearchScreenSaverActivationFlag.val(),\r\n");
      out.write("\t\t\t\tg_searchListOrderByName,\r\n");
      out.write("\t\t\t\tg_searchListOrderByDirection,\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"에이전트 설정 현황 조회\", \"에이전트 설정 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"COMPANYNAME\" class=\"ui-state-default\">사업장</th>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"DEPTNAME\" class=\"ui-state-default\">부서</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"USERNAME\" class=\"ui-state-default\">사용자 명</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th colspan=\"6\" class=\"ui-state-default\">기본 정책</th>';\r\n");
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("WATERMARKOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">워터마크</th>';\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("MEDIACONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th colspan=\"2\" class=\"ui-state-default\">매체 제어</th>';\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("NETWORKSERVICECONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">네트워크 서비스 제어</th>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th colspan=\"3\" class=\"ui-state-default\">시스템 제어</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '<tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"JOBPROCESSINGTYPE\" class=\"ui-state-default\">검출파일<br />처리유형</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"FORCEDTERMINATIONFLAG\" class=\"ui-state-default\">강제종료<br />차단</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"DECORDINGPERMISSIONFLAG\" class=\"ui-state-default\">복호화<br />허용</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"CONTENTCOPYPREVENTIONFLAG\" class=\"ui-state-default\">복사 방지</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"REALTIMEOBSERVATIONFLAG\" class=\"ui-state-default\">실시간 감시</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"PASSWORDEXPIRATIONFLAG\" class=\"ui-state-default\">비밀번호<br />유효기간</th>';\r\n");
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("WATERMARKOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"WMPRINTMODE\" class=\"ui-state-default\">출력 모드</th>';\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("MEDIACONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"USBCONTROLFLAG\" class=\"ui-state-default\">USB 제어</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"CDROMCONTROLFLAG\" class=\"ui-state-default\">CD-ROM 제어</th>';\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("NETWORKSERVICECONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"NETWORKSERVICECONTROLFLAG\" class=\"ui-state-default\">네트워크<br />서비스 제어</th>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"SYSTEMPASSWORDSETUPFLAG\" class=\"ui-state-default\">비밀번호<br />설정</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"SYSTEMPASSWORDEXPIRATIONFLAG\" class=\"ui-state-default\">비밀번호<br />유효기간</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th id=\"SCREENSAVERACTIVATIONFLAG\" class=\"ui-state-default\">화면보호기<br />설정</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar jobProcessingType = $(this).find('jobprocessingtype').text();\r\n");
      out.write("\t\t\t\t\t\tvar forcedTerminationFlag = $(this).find('forcedterminationflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar decordingPermissionFlag = $(this).find('decordingpermissionflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar contentCopyPreventionFlag = $(this).find('contentcopypreventionflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar realtimeObservationFlag = $(this).find('realtimeobservationflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar passwordExpirationFlag = $(this).find('passwordexpirationflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar passwordExpirationPeriod = $(this).find('passwordexpirationperiod').text();\r\n");
      out.write("\t\t\t\t\t\tvar wmPrintMode = $(this).find('wmprintmode').text();\r\n");
      out.write("\t\t\t\t\t\tvar usbControlFlag = $(this).find('usbcontrolflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar usbControlType = $(this).find('usbcontroltype').text();\r\n");
      out.write("\t\t\t\t\t\tvar cdromControlFlag = $(this).find('cdromcontrolflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar cdromControlType = $(this).find('cdromcontroltype').text();\r\n");
      out.write("\t\t\t\t\t\tvar networkServiceControlFlag = $(this).find('networkservicecontrolflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar systemPasswordSetupFlag = $(this).find('systempasswordsetupflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar systemPasswordExpirationFlag = $(this).find('systempasswordexpirationflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar systemPasswordExpirationPeriod = $(this).find('systempasswordexpirationperiod').text();\r\n");
      out.write("\t\t\t\t\t\tvar screenSaverActivationFlag = $(this).find('screensaveractivationflag').text();\r\n");
      out.write("\t\t\t\t\t\tvar screenSaverWaitingMinutes = $(this).find('screensaverwaitingminutes').text();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<tr companyid=\"' + companyId + '\" deptcode=\"' + deptCode + '\" userid=\"' + userId + '\" class=\"' + lineStyle + '\">';\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htJobProcessingTypeList.get(jobProcessingType) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(forcedTerminationFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(decordingPermissionFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(contentCopyPreventionFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(realtimeObservationFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\tif (passwordExpirationFlag == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + passwordExpirationPeriod.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + \"일\" + '</td>';\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(passwordExpirationFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("WATERMARKOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htPrintModeList.get(wmPrintMode) + '</td>';\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("MEDIACONTROLOPTION"))) { 
      ...
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + g_htControlTypeList.get(usbControlType) + '</td>';\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(usbControlFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\tif (cdromControlFlag == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + g_htControlTypeList.get(cdromControlType) + '</td>';\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(cdromControlFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("NETWORKSERVICECONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(networkServiceControlFlag) + '</td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(systemPasswordSetupFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\tif (systemPasswordExpirationFlag == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + systemPasswordExpirationPeriod.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + \"일\" + '</td>';\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(systemPasswordExpirationFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\tif (screenSaverActivationFlag == '");
      out.print(OptionType.OPTION_TYPE_YES);
      out.write("') {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + screenSaverWaitingMinutes.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + \"분\" + '</td>';\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td>' + g_htOptionMarkList.get(screenSaverActivationFlag) + '</td>';\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\tvar fullTdSize = 12;\r\n");
 if (!AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\tfullTdSize = fullTdSize-1;\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("WATERMARKOPTION"))) { 
 ...
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("MEDIACONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\tfullTdSize = fullTdSize+2;\r\n");
 } 
      out.write('\r');
      out.write('\n');
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("NETWORKSERVICECONTROLOPTION"))) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<tr>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"' + fullTdSize + '\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 에이전트 설정 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tbody>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '</table>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 에이전트 설정 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 에이전트 설정 현황');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'dept') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('부서 에이전트 설정 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'user') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('에이전트 설정 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 에이전트 설정 현황');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objAgentConfigStatusList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"에이전트 설정 현황 조회\", \"에이전트 설정 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadConfigData = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objAgentConfigStatusList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objAgentConfigStatusList.find('#search-result');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateAgentConfigStatusListFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\ttargetUserId,\r\n");
      out.write("\t\t\t\tobjSearchJobProcessingType.val(),\r\n");
      ...
      out.write("\t\tvar downloadFileName = \"에이전트 설정 현황 (\" + currentDate.formatString(\"yyyy-MM-dd\") + \")\";\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"검사 현황\", downloadFileName, postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">에이전트 설정 현황</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"agentconfigstatus-list\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\">\r\n");
      out.write("\t\t\t\t<table class=\"search-condition-table\">\r\n");
      out.write("\t\t\t\t\t<colgroup>\r\n");
      out.write("\t\t\t\t\t\t<col width=\"120\" />\r\n");
      out.write("\t\t\t\t\t\t<col />\r\n");
      out.write("\t\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th class=\"ui-state-default\">기본 정책</th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"search-condition-table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<colgroup>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>검출파일 처리유형</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchjobprocessingtype\" name=\"searchjobprocessingtype\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>강제종료 차단</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchforcedterminationflag\" name=\"searchforcedterminationflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>복호화 허용</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchdecordingpermissionflag\" name=\"searchdecordingpermissionflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>복사 방지</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchcontentcopypreventionflag\" name=\"searchcontentcopypreventionflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>실시간 감시</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchrealtimeobservationflag\" name=\"searchrealtimeobservationflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>비밀번호 유효기간 설정</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchpasswordexpirationflag\" name=\"searchpasswordexpirationflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("WATERMARKOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th class=\"ui-state-default\">워터마크</th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"search-condition-table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<col width=\"20%\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>출력 모드</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchwmprintmode\" name=\"searchwmprintmode\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
 ...
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("MEDIACONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th class=\"ui-state-default\">매체 제어</th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"search-condition-table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<col width=\"20%\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>USB 제어</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchusbcontrolflag\" name=\"searchusbcontrolflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>CD-ROM 제어</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchcdromcontrolflag\" name=\"searchcdromcontrolflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
 ...
 if (SupportFunctionType.SUPPORT_FUNCTION_TYPE_ACTIVATE.equals((String) session.getAttribute("NETWORKSERVICECONTROLOPTION"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th class=\"ui-state-default\">네트워크 서비스 제어</th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"search-condition-table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<col width=\"20%\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>네트워크 서비스 제어</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchnetworkservicecontrolflag\" name=\"searchnetworkservicecontrolflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td></td>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th class=\"ui-state-default\">시스템 제어</th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table class=\"search-condition-table\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<col width=\"20%\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t</colgroup>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>비밀번호 설정</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchsystempasswordsetupflag\" name=\"searchsystempasswordsetupflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>비밀번호 유효기간 설정</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchsystempasswordexpirationflag\" name=\"searchsystempasswordexpirationflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>화면보호기 설정</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><select id=\"searchscreensaveractivationflag\" name=\"searchscreensaveractivationflag\" class=\"ui-widget-content\"></select></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
