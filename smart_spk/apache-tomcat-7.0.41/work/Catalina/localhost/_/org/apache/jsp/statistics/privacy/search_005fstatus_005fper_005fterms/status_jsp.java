 ...
 * Generated at: 2021-10-13 01:43:46 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.statistics.privacy.search_005fstatus_005fper_005fterms;
...
public final class status_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/statistics/privacy/search_status_per_terms/statusbody.jsp", Long.valueOf(1623113793000L));
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\r\n");
      out.write("\t<link rel=\"stylesheet\" type=\"text/css\" href=\"/js/jquery-ui-month-picker-master/demo/MonthPicker.min.css\" />\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"/js/jquery-ui-month-picker-master/demo/MonthPicker.min.js\"></script>\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t\t\t\tg_selectedTabIndex = ui.newTab.index();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t//$('#tab-main').tabs('option', \"show\", { effect: 'blind', duration: 1000 });\r\n");
      out.write("\r\n");
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">통계</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"parent-path\">기간별</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">검사 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\tvar g_objTabDaily;\r\n");
      out.write("\tvar g_objTabMonthly;\r\n");
      out.write("\r\n");
      out.write("\tvar g_columnChart = null;\r\n");
      out.write("\tvar g_doughnutChart = null;\r\n");
      out.write("\r\n");
      out.write("\tvar g_selectedTabIndex = TAB_DAILY;\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objTabDaily = $('#tab-daily');\r\n");
      out.write("\t\tg_objTabMonthly = $('#tab-monthly');\r\n");
      out.write("\r\n");
      out.write("\t\t$( document ).tooltip();\r\n");
      out.write("\r\n");
      out.write("\t\t$('button').button();\r\n");
      out.write("\t\t$('button[name=\"btnSearchDaily\"]').button({ icons: {primary: \"ui-icon-search\"} });\r\n");
      out.write("\t\t$('button[name=\"btnSearchMonthly\"]').button({ icons: {primary: \"ui-icon-search\"} });\r\n");
      out.write("\t\t$('button[name=\"btnDownload\"]').button({ icons: {primary: \"ui-icon-arrowstop-1-s\"} });\r\n");
      out.write("\r\n");
      out.write("\t\tg_objTabDaily.find('#searchdailydatefrom').datepicker({\r\n");
      out.write("\t\t\tmaxDate: 0,\r\n");
      out.write("\t\t\tshowAnim: \"slideDown\",\r\n");
      out.write("\t\t\tonSelect: function(selectedDate) {\r\n");
      out.write("\t\t\t\tvar selectSearchDateTo = new Date(selectedDate);\r\n");
      out.write("\t\t\t\tselectSearchDateTo.addDate(\"d\", 6);\r\n");
      out.write("\t\t\t\tif (selectSearchDateTo.getTime() > new Date().getTime()) {\r\n");
      out.write("\t\t\t\t\tselectSearchDateTo = new Date();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tg_objTabDaily.find('#searchdailydateto').datepicker('setDate', selectSearchDateTo);\r\n");
      out.write("\t\t\t\t$('button[name=\"btnDownload\"]').hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\tg_objTabDaily.find('#searchdailydateto').datepicker({\r\n");
      out.write("\t\t\tmaxDate: 0,\r\n");
      out.write("\t\t\tshowAnim: \"slideDown\",\r\n");
      out.write("\t\t\tonSelect: function(selectedDate) {\r\n");
      out.write("\t\t\t\tvar selectSearchDateFrom = new Date(selectedDate);\r\n");
      out.write("\t\t\t\tselectSearchDateFrom.addDate(\"d\", -6);\r\n");
      out.write("\t\t\t\tg_objTabDaily.find('#searchdailydatefrom').datepicker('setDate', selectSearchDateFrom);\r\n");
      out.write("\t\t\t\t$('button[name=\"btnDownload\"]').hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objTabDaily.find('#searchdailydatefrom').datepicker('setDate', tmpDate);\r\n");
      out.write("\t\tg_objTabDaily.find('#searchdailydateto').datepicker('setDate', new Date());\r\n");
      out.write("\r\n");
      out.write("\t\tg_objTabMonthly.find('#searchmonthlydatefrom').MonthPicker({\r\n");
      out.write("\t\t\tButton: false,\r\n");
      out.write("\t\t\tMonthFormat: 'yy-mm',\r\n");
      out.write("\t\t\tMaxMonth: 0,\r\n");
      out.write("\t\t\tSelectedMonth: '-5m',\r\n");
      out.write("\t\t\tIsRTL: false,\r\n");
      out.write("\t\t\ti18n: {\r\n");
      out.write("\t\t\t\tyear: '선택연도',\r\n");
      out.write("\t\t\t\tprevYear: '이전',\r\n");
      out.write("\t\t\t\tnextYear: '다음',\r\n");
      out.write("\t\t\t\tnext12Years: '다음',\r\n");
      out.write("\t\t\t\tprev12Years: '이전',\r\n");
      out.write("\t\t\t\tnextLabel: '다음',  \r\n");
      out.write("\t\t\t\tprevLabel: '이전',\r\n");
      out.write("\t\t\t\tjumpYears: '연도 선택',\r\n");
      out.write("\t\t\t\tbackTo: '되돌아가기',\r\n");
      out.write("\t\t\t\tmonths: [\"1월\", \"2월\", \"3월\", \"4월\", \"5월\", \"6월\", \"7월\", \"8월\", \"9월\", \"10월\", \"11월\", \"12월\"]\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\tOnAfterChooseMonth: function(selectedDate) {\r\n");
      out.write("\t\t\t\tvar selectSearchDateTo = new Date(selectedDate);\r\n");
      out.write("\t\t\t\tselectSearchDateTo.addDate(\"m\", 5);\r\n");
      out.write("\t\t\t\tif (selectSearchDateTo.getTime() > new Date().getTime()) {\r\n");
      out.write("\t\t\t\t\tselectSearchDateTo = new Date();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tg_objTabMonthly.find('#searchmonthlydateto').MonthPicker('option', 'SelectedMonth', selectSearchDateTo);\r\n");
      out.write("\t\t\t\t$('button[name=\"btnDownload\"]').hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\tg_objTabMonthly.find('#searchmonthlydateto').MonthPicker({\r\n");
      out.write("\t\t\tButton: false,\r\n");
      out.write("\t\t\tMonthFormat: 'yy-mm',\r\n");
      out.write("\t\t\tMaxMonth: 0,\r\n");
      out.write("\t\t\tSelectedMonth: 0,\r\n");
      out.write("\t\t\tIsRTL: false,\r\n");
      out.write("\t\t\ti18n: {\r\n");
      out.write("\t\t\t\tyear: '선택연도',\r\n");
      out.write("\t\t\t\tprevYear: '이전',\r\n");
      ...
      out.write("\t\t\tOnAfterChooseMonth: function(selectedDate) {\r\n");
      out.write("\t\t\t\tvar selectSearchDateFrom = new Date(selectedDate);\r\n");
      out.write("\t\t\t\tselectSearchDateFrom.addDate(\"m\", -5);\r\n");
      out.write("\t\t\t\tg_objTabMonthly.find('#searchmonthlydatefrom').MonthPicker('option', 'SelectedMonth', selectSearchDateFrom);\r\n");
      out.write("\t\t\t\t$('button[name=\"btnDownload\"]').hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t\tif ($(this).attr('id') == 'btnSearchDaily') {\r\n");
      out.write("\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t} else if ($(this).attr('id') == 'btnSearchMonthly') {\r\n");
      out.write("\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t} else if ($(this).attr('id') == 'btnDownload') {\r\n");
      out.write("\t\t\t\tdownloadStatisticsData();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('사업장 검사 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('전체 검사 현황');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t} else if (data.rslt.obj.attr('node_type') == \"dept\") {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('부서 검사 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t\t} else if (data.rslt.obj.attr('node_type') == \"user\") {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('사용자 검사 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 검사 현황');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadStatisticsData = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objTreeReference = $.jstree._reference(g_objOrganizationTree);\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar termType = \"\";\r\n");
      out.write("\t\tvar searchDateFrom;\r\n");
      out.write("\t\tvar searchDateTo;\r\n");
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY) {\r\n");
      out.write("\t\t\ttermType = \"DAY\";\r\n");
      out.write("\t\t\tsearchDateFrom = new Date(g_objTabDaily.find('#searchdailydatefrom').datepicker('getDate'));\r\n");
      out.write("\t\t\tsearchDateTo = new Date(g_objTabDaily.find('#searchdailydateto').datepicker('getDate'));\r\n");
      out.write("\t\t\tif (searchDateTo.diffDays(searchDateFrom, \"d\") >= 7) {\r\n");
      out.write("\t\t\t\tdisplayAlertDialog(\"기간 선택 오류\", \"일별 조회 기간은 7일을 초과할 수 없습니다.\", null);\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t} else if (g_selectedTabIndex == TAB_MONTHLY) {\r\n");
      out.write("\t\t\ttermType = \"MONTH\";\r\n");
      out.write("\t\t\tsearchDateFrom = new Date(g_objTabMonthly.find('#searchmonthlydatefrom').MonthPicker('GetSelectedDate'));\r\n");
      out.write("\t\t\tsearchDateTo = new Date(g_objTabMonthly.find('#searchmonthlydateto').MonthPicker('GetSelectedDate'));\r\n");
      out.write("\t\t\tsearchDateTo = new Date(searchDateTo.getFullYear(), searchDateTo.getMonth() + 1, 0);\r\n");
      out.write("\t\t\tif (searchDateTo.diffDays(searchDateFrom, \"m\") >= 6) {\r\n");
      out.write("\t\t\t\tdisplayAlertDialog(\"기간 선택 오류\", \"월별 조회 기간은 6개월을 초과할 수 없습니다.\", null);\r\n");
      out.write("\t\t\t\treturn false;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestSearchStatusPerTermsParam(targetCompanyId,\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"기간별 검사 현황 조회\", \"기간별 검사 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tloadColumnChart($(data));\r\n");
      out.write("\t\t\t\tloadColumnChartTable($(data));\r\n");
      out.write("\t\t\t\tloadDoughnutChart($(data));\r\n");
      out.write("\t\t\t\tloadDoughnutChartTable($(data));\r\n");
      out.write("\r\n");
      out.write(" \t\t\t\t$('button[name=\"btnDownload\"]').show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"기간별 검사 현황 조회\", \"기간별 검사 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadColumnChart = function(responseData) {\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tvar ctx;\r\n");
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY) {\r\n");
      out.write("\t\t\tctx = document.getElementById('daily-column-chart').getContext('2d');\r\n");
      out.write("\t\t} else if (g_selectedTabIndex == TAB_MONTHLY) {\r\n");
      out.write("\t\t\tctx = document.getElementById('monthly-column-chart').getContext('2d');\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tif (g_columnChart != null) g_columnChart.destroy();\r\n");
      out.write("\r\n");
      out.write("\t\tg_columnChart = new Chart(ctx, {\r\n");
      out.write("\t\t\ttype: 'bar',\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadColumnChartTable = function(responseData) {\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY)\r\n");
      out.write("\t\t\thtmlContents += '<th width=\"70\" class=\"ui-state-default\">검사일자</th>';\r\n");
      out.write("\t\telse if (g_selectedTabIndex == TAB_MONTHLY)\r\n");
      out.write("\t\t\thtmlContents += '<th width=\"70\" class=\"ui-state-default\">검사년월</th>';\r\n");
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">강제검사</th>';\r\n");
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">실시간검사</th>';\r\n");
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">일반검사</th>';\r\n");
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">빠른검사</th>';\r\n");
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">예약검사</th>';\r\n");
      out.write("\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\tvar date = $(this).find('date').text();\r\n");
      out.write("\t\t\tvar forceSearchCount = parseInt($(this).find('forcesearchcount').text());\r\n");
      out.write("\t\t\tvar realtimeSearchCount = parseInt($(this).find('realtimesearchcount').text());\r\n");
      out.write("\t\t\tvar normalSearchCount = parseInt($(this).find('normalsearchcount').text());\r\n");
      out.write("\t\t\tvar fastSearchCount = parseInt($(this).find('fastsearchcount').text());\r\n");
      out.write("\t\t\tvar reserveSearchCount = parseInt($(this).find('reservesearchcount').text());\r\n");
      out.write("\r\n");
      out.write("\t\t\thtmlContents += '<tr class=\"' + lineStyle + '\">';\r\n");
      out.write("\t\t\thtmlContents += '<td style=\"text-align: center;\">' + date + '</td>';\r\n");
      out.write("\t\t\thtmlContents += '<td style=\"text-align: right;\">' + forceSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\t\thtmlContents += '<td style=\"text-align: right;\">' + realtimeSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\t\thtmlContents += '<td style=\"text-align: right;\">' + normalSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\t\thtmlContents += '<td style=\"text-align: right;\">' + fastSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\t\thtmlContents += '<td style=\"text-align: right;\">' + reserveSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\thtmlContents += '</tbody>';\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY) {\r\n");
      out.write("\t\t\t$('#daily-column-chart-table').html(htmlContents);\r\n");
      out.write("\t\t} else if (g_selectedTabIndex == TAB_MONTHLY) {\r\n");
      out.write("\t\t\t$('#monthly-column-chart-table').html(htmlContents);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadDoughnutChart = function(responseData) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar forceSearchCount = 0;\r\n");
      out.write("\t\tvar realtimeSearchCount = 0;\r\n");
      out.write("\t\tvar normalSearchCount = 0;\r\n");
      out.write("\t\tvar fastSearchCount = 0;\r\n");
      out.write("\t\tvar reserveSearchCount = 0;\r\n");
      out.write("\r\n");
      out.write("\t\tresponseData.find('record').each( function() {\r\n");
      out.write("\t\t\tforceSearchCount += parseInt($(this).find('forcesearchcount').text());\r\n");
      out.write("\t\t\trealtimeSearchCount += parseInt($(this).find('realtimesearchcount').text());\r\n");
      out.write("\t\t\tnormalSearchCount += parseInt($(this).find('normalsearchcount').text());\r\n");
      out.write("\t\t\tfastSearchCount += parseInt($(this).find('fastsearchcount').text());\r\n");
      out.write("\t\t\treserveSearchCount += parseInt($(this).find('reservesearchcount').text());\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\tvar arrlabel = [\"강제검사\", \"실시간검사\", \"일반검사\", \"빠른검사\", \"예약검사\"];\r\n");
      out.write("\t\tvar arrData = [];\r\n");
      out.write("\t\tarrData.push(forceSearchCount.toString());\r\n");
      out.write("\t\tarrData.push(realtimeSearchCount.toString());\r\n");
      out.write("\t\tarrData.push(normalSearchCount.toString());\r\n");
      out.write("\t\tarrData.push(fastSearchCount.toString());\r\n");
      out.write("\t\tarrData.push(reserveSearchCount.toString());\r\n");
      out.write("\r\n");
      out.write("\t\tvar chartData = {\r\n");
      out.write("\t\t\tlabels: arrlabel,\r\n");
      out.write("\t\t\tdatasets: [{\r\n");
      out.write("\t\t\t\tlabel: '검사 현황',\r\n");
      ...
      out.write("\t\t\t\t\t'rgba(204, 0, 0, 0.6)',\r\n");
      out.write("\t\t\t\t\t'rgba(54, 162, 235, 0.6)',\r\n");
      out.write("\t\t\t\t\t'rgba(65, 105, 225, 0.6)',\r\n");
      out.write("\t\t\t\t\t'rgba(255, 140, 0, 0.6)',\r\n");
      out.write("\t\t\t\t\t'rgba(153, 051, 153, 0.6)',\r\n");
      out.write("\t\t\t\t],\r\n");
      ...
      out.write("\t\tvar ctx;\r\n");
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY) {\r\n");
      out.write("\t\t\tctx = document.getElementById('daily-doughnut-chart').getContext('2d');\r\n");
      out.write("\t\t} else if (g_selectedTabIndex == TAB_MONTHLY) {\r\n");
      out.write("\t\t\tctx = document.getElementById('monthly-doughnut-chart').getContext('2d');\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tif (g_doughnutChart != null) g_doughnutChart.destroy();\r\n");
      out.write("\r\n");
      out.write("\t\tg_doughnutChart = new Chart(ctx, {\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadDoughnutChartTable = function(responseData) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar htmlContents = '';\r\n");
      out.write("\r\n");
      out.write("\t\thtmlContents += '<table class=\"list-table\">';\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\thtmlContents += '<tr class=list-odd\">';\r\n");
      out.write("\t\thtmlContents += '<td style=\"text-align: right;\">' + forceSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\thtmlContents += '<td style=\"text-align: right;\">' + realtimeSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\thtmlContents += '<td style=\"text-align: right;\">' + normalSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\thtmlContents += '<td style=\"text-align: right;\">' + fastSearchCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY)\r\n");
      out.write("\t\t\t$('#daily-doughnut-chart-table').html(htmlContents);\r\n");
      out.write("\t\telse if (g_selectedTabIndex == TAB_MONTHLY)\r\n");
      out.write("\t\t\t$('#monthly-doughnut-chart-table').html(htmlContents);\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadStatisticsData = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objTreeReference = $.jstree._reference(g_objOrganizationTree);\r\n");
      out.write("\r\n");
      out.write("\t\tvar targetCompanyId = \"\"; \r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateSearchStatusPerTermsFileParam(targetCompanyId,\r\n");
      out.write("\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\ttargetUserId,\r\n");
      out.write("\t\t\ttermType,\r\n");
      out.write("\t\t\tsearchDateFrom.formatString(\"yyyy-MM-dd\"),\r\n");
      out.write("\t\t\tsearchDateTo.formatString(\"yyyy-MM-dd\"));\r\n");
      out.write("\r\n");
      out.write("\t\tvar downloadFileName = \"\";\r\n");
      out.write("\t\tif (g_selectedTabIndex == TAB_DAILY) {\r\n");
      out.write("\t\t\tdownloadFileName += \"일별 검사 현황\";\r\n");
      out.write("\t\t\tdownloadFileName += \" (\" + searchDateFrom.formatString(\"yyyy-MM-dd\") + \"~\" + searchDateTo.formatString(\"yyyy-MM-dd\") + \")\";\r\n");
      out.write("\t\t} else if (g_selectedTabIndex == TAB_MONTHLY) {\r\n");
      out.write("\t\t\tdownloadFileName += \"월별 검사 현황\";\r\n");
      out.write("\t\t\tdownloadFileName += \" (\" + searchDateFrom.formatString(\"yyyy-MM\") + \"~\" + searchDateTo.formatString(\"yyyy-MM\") + \")\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"tab-main\" class=\"inner-center styles-tab\">\r\n");
      out.write("\t<div class=\"pane-header\">전체 사업장 검사 현황</div>\r\n");
      out.write("\t<ul>\r\n");
      out.write("\t\t<li><a href=\"#tab-daily\">일별 검사 현황</a></li>\r\n");
      out.write("\t\t<li><a href=\"#tab-monthly\">월별 검사 현황</a></li>\r\n");
      out.write("\t</ul>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"tab-daily\" class=\"zero-padding\">\r\n");
      ...
      out.write("\t\t\t\t<input type=\"text\" id=\"searchdailydatefrom\" name=\"searchdailydatefrom\" class=\"text ui-widget-content input-date\" readonly=\"readonly\" />\r\n");
      out.write("\t\t\t\t~<input type=\"text\" id=\"searchdailydateto\" name=\"searchdailydateto\" class=\"text ui-widget-content input-date\" readonly=\"readonly\" />\r\n");
      out.write("\t\t\t\t<span class=\"search-button\">\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" id=\"btnSearchDaily\" name=\"btnSearchDaily\" class=\"small-button\">조 회</button>\r\n");
      out.write("\t\t\t\t</span>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t<div class=\"sub-category-contents\">\r\n");
      out.write("\t\t\t\t<div style=\"float: left; width: 50%;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"chart-container\" style=\"width: 100%; height: 240px;\"><canvas id=\"daily-column-chart\"></canvas></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"margin-left: 51%;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"daily-column-chart-table\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"sub-category-contents\" style=\"margin-top: 15px;\">\r\n");
      out.write("\t\t\t\t<div style=\"float: left; width: 50%;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"chart-container\" style=\"width: 100%; height: 240px;\"><canvas id=\"daily-doughnut-chart\"></canvas></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"margin-left: 51%;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"daily-doughnut-chart-table\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"tab-monthly\" class=\"zero-padding\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\" class=\"inline-search-condition\">\r\n");
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>조회 기간\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"searchmonthlydatefrom\" name=\"searchmonthlydatefrom\" class=\"text ui-widget-content input-month\" readonly=\"readonly\" />\r\n");
      out.write("\t\t\t\t~<input type=\"text\" id=\"searchmonthlydateto\" name=\"searchmonthlydateto\" class=\"text ui-widget-content input-month\" readonly=\"readonly\" />\r\n");
      out.write("\t\t\t\t<span class=\"search-button\">\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" id=\"btnSearchMonthly\" name=\"btnSearchMonthly\" class=\"small-button\">조 회</button>\r\n");
      out.write("\t\t\t\t</span>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t<div class=\"sub-category-contents\">\r\n");
      out.write("\t\t\t\t<div style=\"float: left; width: 50%;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"chart-container\" style=\"width: 100%; height: 240px;\"><canvas id=\"monthly-column-chart\"></canvas></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"margin-left: 51%;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"monthly-column-chart-table\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"sub-category-contents\" style=\"margin-top: 15px;\">\r\n");
      out.write("\t\t\t\t<div style=\"float: left; width: 50%;\">\r\n");
      out.write("\t\t\t\t\t<div class=\"chart-container\" style=\"width: 100%; height: 240px;\"><canvas id=\"monthly-doughnut-chart\"></canvas></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"margin-left: 51%;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"monthly-doughnut-chart-table\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
