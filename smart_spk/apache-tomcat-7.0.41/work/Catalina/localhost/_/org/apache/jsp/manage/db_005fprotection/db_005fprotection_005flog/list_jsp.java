 ...
 * Generated at: 2021-10-29 01:49:47 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.manage.db_005fprotection.db_005fprotection_005flog;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/db_protection/db_protection_log/dbprotectionlog-dialog.jsp", Long.valueOf(1623113790000L));
    _jspx_dependants.put("/include/dialog/confirm-dialog.jsp", Long.valueOf(1623113786000L));
    _jspx_dependants.put("/manage/db_protection/db_protection_log/listbody.jsp", Long.valueOf(1623113790000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">DB 보안 관리</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">DB 보안 로그</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\topenDbProtectionLogInfoDialog = function(seqNo) {\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDbProtectionLogInfoParam(seqNo);\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\turl: \"/CommandService\",\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"DB 보안 로그 정보 조회\", \"DB 보안 로그 정보 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      ...
      out.write("\t\t\t\tif (logContents.length == 0)\r\n");
      ...
      out.write("\t\t\t\tdialogContents = '<div title=\"DB 보안 로그 정보\" class=\"dialog-form\">';\r\n");
      ...
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">IP 주소</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"ipaddress\">' + $(data).find('ipaddress').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-clientid\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">MAC 주소</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"clientid\">' + $(data).find('clientid').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-logtype\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">로그 유형</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"logtype\">' + g_htDbProtectionLogTypeList.get($(data).find('logtype').text()) + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-logContents\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">로그 내용</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-contents\"><div id=\"logcontents\" style=\"width: 98%; height: 120px; overflow: auto;\">' + logContents + '</div></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"clear\"></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div id=\"row-logdatetime\" class=\"field-line\">';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-title\">처리 일시</div>';\r\n");
      out.write("\t\t\t\tdialogContents += '<div class=\"field-value\"><span id=\"logdatetime\">' + $(data).find('logdatetime').text() + '</span></div>';\r\n");
      out.write("\t\t\t\tdialogContents += '</div>';\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"DB 보안 로그 정보 조회\", \"DB 보안 로그 정보 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\tvar g_objDbProtectionLogList;\r\n");
      out.write("\r\n");
      out.write("\tvar g_htDbProtectionLogTypeList = new Hashtable();\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objDbProtectionLogList = $('#dbprotectionlog-list');\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tg_htDbProtectionLogTypeList = loadTypeList(\"DB_PROTECTION_LOG_TYPE\");\r\n");
      out.write("\t\tif (g_htDbProtectionLogTypeList.isEmpty()) {\r\n");
      out.write("\t\t\tdisplayAlertDialog(\"DB 보안 로그 유형 조회\", \"DB 보안 로그 유형 조회 중 오류가 발생하였습니다.\", \"자세한 사항은 시스템 관리자에게 문의해 주십시오.\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objDbProtectionLogList.find('#search-condition').find('select[name=\"searchdbprotectionlogtype\"]'), g_htDbProtectionLogTypeList, null, \"전체\");\r\n");
      out.write("\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      ...
      out.write("\t\tloadDbProtectionLogList();\r\n");
 } 
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(document).on(\"click\", \".list-table tbody tr\", function() { if (typeof $(this).attr('seqno') != typeof undefined) { openDbProtectionLogInfoDialog($(this).attr('seqno')); } });\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadDbProtectionLogList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchCondition = g_objDbProtectionLogList.find('#search-condition');\r\n");
      out.write("\t\tvar objSearchResult = g_objDbProtectionLogList.find('#search-result');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchIpAddress = objSearchCondition.find('input[name=\"searchipaddress\"]');\r\n");
      out.write("\t\tvar objSearchDbProtectionLogType = objSearchCondition.find('select[name=\"searchdbprotectionlogtype\"]');\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDbProtectionLogListParam(targetCompanyId,\r\n");
      out.write("\t\t\tobjSearchIpAddress.val(),\r\n");
      out.write("\t\t\tobjSearchDbProtectionLogType.val(),\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"DB 보안 로그 목록 조회\", \"DB 보안 로그 목록 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">IP 주소</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">로그 유형</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">처리 일시</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '<th class=\"ui-state-default\">등록 일시</th>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\t\t\t\t\t\tvar ipAddress = $(this).find('ipaddress').text();\r\n");
      out.write("\t\t\t\t\t\tvar logType = $(this).find('logtype').text();\r\n");
      out.write("\t\t\t\t\t\tvar logDatetime = $(this).find('logdatetime').text();\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + ipAddress + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td>' + g_htDbProtectionLogTypeList.get(logType) + '</td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: center;\">' + logDatetime + '</span></td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td style=\"text-align: center;\">' + createDatetime + '</span></td>';\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tbody>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"5\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 DB 보안 로그가 존재하지 않습니다.</div></td>';\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '<td colspan=\"4\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 DB 보안 로그가 존재하지 않습니다.</div></td>';\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 DB 보안 로그 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 DB 보안 로그 목록');\r\n");
      out.write("\t\t\t\t}\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t$('.inner-center .pane-header').text('DB 보안 로그 목록');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\tg_objDbProtectionLogList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"DB 보안 로그 목록 조회\", \"DB 보안 로그 목록 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\t<div class=\"pane-header\">DB 보안 로그 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"dbprotectionlog-list\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\" class=\"inline-search-condition\">\r\n");
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>IP 주소\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"searchipaddress\" name=\"searchipaddress\" class=\"text ui-widget-content\" />\r\n");
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>로그 유형\r\n");
      out.write("\t\t\t\t<select id=\"searchdbprotectionlogtype\" name=\"searchdbprotectionlogtype\" class=\"ui-widget-content\"></select>\r\n");
