 ...
 * Generated at: 2021-10-19 02:21:07 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.statistics.privacy.dept_005fdetect_005fstatus_005fper_005fpattern;
...
public final class status_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/statistics/privacy/dept_detect_status_per_pattern/statusbody.jsp", Long.valueOf(1623113793000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">패턴별</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">부서 검출 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tg_objMainContent.find('#searchdatefrom').datepicker({\r\n");
      out.write("\t\t\tmaxDate: 0,\r\n");
      out.write("\t\t\tshowAnim: \"slideDown\",\r\n");
      out.write("\t\t\tonSelect: function(selectedDate) {\r\n");
      out.write("\t\t\t\tg_objMainContent.find('#searchdateto').datepicker('option', 'minDate', selectedDate);\r\n");
      out.write("\t\t\t\t$('button[name=\"btnDownload\"]').hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\tg_objMainContent.find('#searchdateto').datepicker({\r\n");
      out.write("\t\t\tmaxDate: 0,\r\n");
      out.write("\t\t\tshowAnim: \"slideDown\",\r\n");
      out.write("\t\t\tonSelect: function(selectedDate) {\r\n");
      out.write("\t\t\t\tg_objMainContent.find('#searchdatefrom').datepicker('option', 'maxDate', selectedDate);\r\n");
      out.write("\t\t\t\t$('button[name=\"btnDownload\"]').hide();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objMainContent.find('#searchdatefrom').datepicker('setDate', tmpDate);\r\n");
      out.write("\t\tg_objMainContent.find('#searchdateto').datepicker('setDate', new Date());\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\tfillDropdownList(g_objMainContent.find('#search-condition').find('select[name=\"searchcompany\"]'), g_htCompanyList, null, null);\r\n");
 } 
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tfillDropdownList(g_objMainContent.find('#search-condition').find('select[name=\"searchsearchtype\"]'), g_htSearchTypeList, null, \"전체\");\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tvar postData = getRequestCompanyListParam(companyId, '', '', 'COMPANYNAME', 'ASC', '', '');\r\n");
      out.write("\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype: \"POST\",\r\n");
      out.write("\t\t\turl: \"/CommandService\",\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t\t\tif (data.rslt.obj.attr('node_type') == \"pattern_category\") {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('패턴 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t} else if (data.rslt.obj.attr('node_type') == \"pattern\") {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('패턴 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 패턴 검출 현황');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tvar objSearchCompany = g_objMainContent.find('#searchcompany');\r\n");
      out.write("\t\tvar objSearchType = g_objMainContent.find('#searchsearchtype');\r\n");
      out.write("\t\tvar objSearchDateFrom = g_objMainContent.find('#searchdatefrom');\r\n");
      out.write("\t\tvar objSearchDateTo = g_objMainContent.find('#searchdateto');\r\n");
      out.write("\r\n");
      out.write("\t\tvar objTreeReference = $.jstree._reference(g_objPatternTree);\r\n");
      out.write("\r\n");
      out.write("\t\tvar targetPatternId = \"\";\r\n");
      out.write("\t\tvar targetPatternSubId = \"\";\r\n");
      ...
      out.write("\t\t\ttargetPatternSubId = \"\";\r\n");
      out.write("\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'pattern') {\r\n");
      out.write("\t\t\ttargetPatternId = objTreeReference.get_selected().attr('patternid');\r\n");
      out.write("\t\t\ttargetPatternSubId = objTreeReference.get_selected().attr('patternsubid');\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\tvar companyId = objSearchCompany.val();\r\n");
 } else { 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDeptDetectStatusPerPatternParam(\r\n");
      out.write("\t\t\t\ttargetPatternId,\r\n");
      out.write("\t\t\t\ttargetPatternSubId,\r\n");
      out.write("\t\t\t\tcompanyId,\r\n");
      out.write("\t\t\t\tobjSearchType.val(),\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"패턴별 부서 검출 현황 조회\", \"패턴별 부서 검출 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t \t\t\t\t$('button[name=\"btnDownload\"]').hide();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tloadChart($(data));\r\n");
      out.write("\t\t\t\tloadChartTable($(data));\r\n");
      out.write("\t\t\t\treloadDefaultLayout();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"패턴별 부서 검출 현황 조회\", \"패턴별 부서 검출 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadChart = function(responseData) {\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\tarrlabel.push($(this).find('deptname').text());\r\n");
      ...
      out.write("\t\t};\r\n");
      out.write("\r\n");
      out.write("\t\tvar ctx = document.getElementById('doughnut-chart').getContext('2d');\r\n");
      out.write("\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadChartTable = function(responseData) {\r\n");
      out.write("\r\n");
      ...
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">검출건수</th>';\r\n");
      out.write("\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\thtmlContents += '</thead>';\r\n");
      out.write("\t\thtmlContents += '<tbody>';\r\n");
      out.write("\r\n");
      out.write("\t\tif (responseData.find('record').length > 0) {\r\n");
      out.write("\t\t\tresponseData.find('record').each( function(index) {\r\n");
      ...
      out.write("\t\t\t\thtmlContents += '<td style=\"text-align: center;\">' + deptName + '</td>';\r\n");
      out.write("\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + detectKeywordCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\thtmlContents += '<td colspan=\"2\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">검출 정보가 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\thtmlContents += '</tbody>';\r\n");
      out.write("\t\thtmlContents += '</table>';\r\n");
      out.write("\r\n");
      out.write("\t\t$('#chart-table').html(htmlContents);\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateDeptDetectStatusPerPatternFileParam(\r\n");
      out.write("\t\t\t\ttargetPatternId,\r\n");
      out.write("\t\t\t\ttargetPatternSubId,\r\n");
      out.write("\t\t\t\tcompanyId,\r\n");
      out.write("\t\t\t\tobjSearchType.val(),\r\n");
      ...
      out.write("\t\t\t\tobjSearchDateTo.val());\r\n");
      out.write("\r\n");
      out.write("\t\tvar downloadFileName = \"패턴별 부서 검출 현황\";\r\n");
      out.write("\t\tdownloadFileName += \" (\" + objSearchDateFrom.val() + \"~\" + objSearchDateTo.val() + \")\";\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"패턴별 부서 검출 현황\", downloadFileName, postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 패턴 검출 현황</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"main-content\" style=\"display: none;\">\r\n");
      out.write("\t\t\t<div id=\"search-condition\" class=\"inline-search-condition\">\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>사업장\r\n");
      out.write("\t\t\t\t<select id=\"searchcompany\" name=\"searchcompany\" class=\"ui-widget-content\"></select>\r\n");
 } 
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"chart-container\" style=\"width: 100%; height: 300px;\"><canvas id=\"doughnut-chart\"></canvas></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div style=\"margin-left: 56%;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"chart-table\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"clear\"></div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t<button type=\"button\" id=\"btnDownload\" name=\"btnDownload\" class=\"normal-button\">목록 다운로드</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
