 ...
 * Generated at: 2021-10-06 01:05:37 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.statistics.agent.agent_005finstall_005fstatus;
...
public final class status_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/statistics/agent/agent_install_status/statusbody.jsp", Long.valueOf(1623113793000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">클라이언트 설치 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('사업장 설치 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('전체 설치 현황');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t} else if (data.rslt.obj.attr('node_type') == \"dept\") {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('부서 설치 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 설치 현황');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestAgentInstallStatusParam(\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"클라이언트 설치 현황 조회\", \"클라이언트 설치 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objMainContent.show();\r\n");
      out.write("\t\t\t\tif ($(data).find('record').length > 0) {\r\n");
      out.write("\t \t\t\t\t$('.inner-center .pane-footer').show();\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t \t\t\t\t$('.inner-center .pane-footer').hide();\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"클라이언트 설치 현황 조회\", \"클라이언트 설치 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\t\t\tarrlabel.push(g_htInstallStateList.get($(this).find('installflag').text()));\r\n");
      out.write("\t\t\tarrData.push($(this).find('statuscount').text());\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t'rgba(255, 0, 0, 0.6)',\r\n");
      out.write("\t\t\t\t\t'rgba(0, 51, 230, 0.6)',\r\n");
      out.write("\t\t\t\t\t'rgba(255, 215, 0, 0.9)',\r\n");
      out.write("\t\t\t\t],\r\n");
      ...
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">설치상태</th>';\r\n");
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">건수</th>';\r\n");
      out.write("\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\thtmlContents += '</thead>';\r\n");
      ...
      out.write("\t\t\tvar statusCount = parseInt($(this).find('statuscount').text());\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\thtmlContents += '<td style=\"text-align: right;\">' + statusCount.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\") + '</td>';\r\n");
      out.write("\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\thtmlContents += '</tbody>';\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateAgentInstallStatusFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList);\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"클라이언트 설치 현황\", \"클라이언트 설치 현황\", postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">조직별 클라이언트 설치 현황</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"main-content\" style=\"padding: 10px; display: none;\">\r\n");
      out.write("\t\t\t<div class=\"sub-category-contents\">\r\n");
      out.write("\t\t\t\t<div style=\"float: left; width: 55%; margin-top: 1px;\">\r\n");
