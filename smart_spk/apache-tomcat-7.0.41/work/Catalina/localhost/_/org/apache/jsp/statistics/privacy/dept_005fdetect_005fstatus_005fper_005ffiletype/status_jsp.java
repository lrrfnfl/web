 ...
 * Generated at: 2021-10-19 02:21:36 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.statistics.privacy.dept_005fdetect_005fstatus_005fper_005ffiletype;
...
public final class status_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/statistics/privacy/dept_detect_status_per_filetype/statusbody.jsp", Long.valueOf(1623113793000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<span class=\"parent-path\">파일 유형별</span> -->\r\n");
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("<!--\r\n");
      out.write("\tvar g_objFileTypeTree;\r\n");
      ...
      out.write("\t$(document).ready(function() {\r\n");
      out.write("\r\n");
      out.write("\t\tg_objFileTypeTree = $('#filetype-tree');\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\tloadFileTypeTreeView();\r\n");
      out.write("\r\n");
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadFileTypeTreeView = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar xmlTreeData = \"\";\r\n");
      out.write("\t\tvar patternNodeXml = \"\";\r\n");
      out.write("\r\n");
      out.write("\t\tif (!g_htFileTypeList.isEmpty()) {\r\n");
      out.write("\t\t\tg_htFileTypeList.each( function(value, name) {\r\n");
      out.write("\t\t\t\tpatternNodeXml += \"<item id='\" + value + \"' parent_id='ALL'  node_type='filetype'>\";\r\n");
      out.write("\t\t\t\tpatternNodeXml += \"<content><name>\" + name + \"</name></content>\";\r\n");
      out.write("\t\t\t\tpatternNodeXml += \"</item>\";\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\txmlTreeData += \"<root>\";\r\n");
      out.write("\t\txmlTreeData += \"<item id='ALL' node_type='ROOT'>\";\r\n");
      out.write("\t\txmlTreeData += \"<content><name>전체 파일 유형</name></content>\";\r\n");
      out.write("\t\txmlTreeData += \"</item>\";\r\n");
      out.write("\t\txmlTreeData += patternNodeXml;\r\n");
      out.write("\t\txmlTreeData += \"</root>\";\r\n");
      out.write("\r\n");
      out.write("\t\tg_objFileTypeTree.jstree({\r\n");
      out.write("\t\t\t\"xml_data\" : {\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t\t\tif (data.rslt.obj.attr('node_type') == \"filetype\") {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('파일 유형 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 파일 유형 검출 현황');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tvar objTreeReference = $.jstree._reference(g_objFileTypeTree);\r\n");
      out.write("\r\n");
      out.write("\t\tvar targetFileType = \"\";\r\n");
      out.write("\t\tif (objTreeReference.get_selected().attr(\"node_type\") == 'filetype') {\r\n");
      out.write("\t\t\ttargetFileType = objTreeReference.get_selected().attr('id');\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDeptDetectStatusPerFileTypeParam(\r\n");
      out.write("\t\t\t\ttargetFileType,\r\n");
      out.write("\t\t\t\tcompanyId,\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"파일 유형별 부서 검출 현황 조회\", \"파일 유형별 부서 검출 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"파일 유형별 부서 검출 현황 조회\", \"파일 유형별 부서 검출 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateDeptDetectStatusPerFileTypeFileParam(\r\n");
      out.write("\t\t\t\ttargetFileType,\r\n");
      out.write("\t\t\t\tcompanyId,\r\n");
      out.write("\t\t\t\tobjSearchType.val(),\r\n");
      out.write("\t\t\t\tobjSearchDateFrom.val(),\r\n");
      out.write("\t\t\t\tobjSearchDateTo.val());\r\n");
      out.write("\r\n");
      out.write("\t\tvar downloadFileName = \"파일 유형별 부서 검출 현황\";\r\n");
      out.write("\t\tdownloadFileName += \" (\" + objSearchDateFrom.val() + \"~\" + objSearchDateTo.val() + \")\";\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"파일 유형별 부서 검출 현황\", downloadFileName, postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<div class=\"inner-west\">\r\n");
      out.write("\t<div class=\"pane-header\">파일 유형 목록</div>\r\n");
      out.write("\t<div class=\"ui-layout-content zero-padding\">\r\n");
      out.write("\t\t<div id=\"filetype-tree\" class=\"treeview-pannel\"></div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("<div class=\"inner-center\">\r\n");
      out.write("\t<div class=\"pane-header\">전체 파일 유형 검출 현황</div>\r\n");
