 ...
 * Generated at: 2021-10-19 02:20:22 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.statistics.privacy.pattern_005fdetect_005fstatus_005fper_005forganization;
...
public final class status_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/statistics/privacy/pattern_detect_status_per_organization/statusbody.jsp", Long.valueOf(1623113793000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">패턴 검출 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('사업장 패턴 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
 } else { 
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('부서 패턴 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t\t} else if (data.rslt.obj.attr('node_type') == \"user\") {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('사용자 패턴 검출 현황 - [' + data.rslt.obj.children('a').text().trim() + ']');\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 패턴 검출 현황');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\tloadStatisticsData();\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestPatternDetectStatusPerOrganizationParam(\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"조직별 패턴 검출 현황 조회\", \"조직별 패턴 검출 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"조직별 패턴 검출 현황 조회\", \"조직별 패턴 검출 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      ...
      out.write("\t\thtmlContents += '<th class=\"ui-state-default\">검출패턴</th>';\r\n");
      ...
      out.write("\t\t\t\thtmlContents += '<td style=\"text-align: center;\">' + patternName + '</td>';\r\n");
      ...
      out.write("\t\tvar objSearchDateTo = g_objMainContent.find('#searchdateto');\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreatePatternDetectStatusPerOrganizationFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\ttargetUserId,\r\n");
      out.write("\t\t\t\tobjSearchType.val(),\r\n");
      ...
      out.write("\t\t\t\tobjSearchDateTo.val());\r\n");
      out.write("\r\n");
      out.write("\t\tvar downloadFileName = \"패턴 검출 현황\";\r\n");
      out.write("\t\tdownloadFileName += \" (\" + objSearchDateFrom.val() + \"~\" + objSearchDateTo.val() + \")\";\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"패턴 검출 현황\", downloadFileName, postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 사업장 패턴 검출 현황</div>\r\n");
