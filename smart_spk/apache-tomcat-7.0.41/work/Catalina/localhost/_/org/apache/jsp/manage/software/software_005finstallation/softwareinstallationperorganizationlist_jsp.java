 ...
 * Generated at: 2021-10-18 00:16:24 UTC
...
public final class softwareinstallationperorganizationlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/manage/software/software_installation/softwareinstallationperorganizationlistbody.jsp", Long.valueOf(1623113790000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">조직별 설치 목록</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\r\n");
      out.write("\t\tvar objSearchSoftwareName = objSearchCondition.find('input[name=\"searchsoftwarename\"]');\r\n");
      ...
      out.write("\t\t\t\tobjSearchSoftwareName.val(),\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('부서 소프트웨어 설치 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'user') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사용자 소프트웨어 설치 목록 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-triangle-1-e\"></span></li></ul>소프트웨어 명\r\n");
      out.write("\t\t\t\t<input type=\"text\" id=\"searchsoftwarename\" name=\"searchsoftwarename\" class=\"text ui-widget-content\" />\r\n");
