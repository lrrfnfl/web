 ...
 * Generated at: 2021-10-13 02:02:56 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.report.privacy.detect_005ffile_005fprocess_005fstatus_005fper_005fuser;
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/report/privacy/detect_file_process_status_per_user/listbody.jsp", Long.valueOf(1623113790000L));
...
if (!mapLoginStatus.isEmpty()) {
 ...
 if ("MEDISAFER".equalsIgnoreCase(oemString) || "BIZSAFER".equalsIgnoreCase(oemString)) { 
      ...
      out.write("<!-- \t\t\t<ul class=\"ui-helper-clearfix icons\"><li><span class=\"ui-icon ui-icon-carat-1-e\"></span></li></ul> -->\r\n");
      out.write("<!-- \t\t\t<span class=\"current-path\">사용자별 처리 현황</span> -->\r\n");
      out.write("<!-- \t\t</div> -->\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\tvar g_objDetectFileProcessStatusPerUserList;\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tg_objDetectFileProcessStatusPerUserList = $('#detectfileprocessstatusperuser-list');\r\n");
      out.write("\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t\t\t\tdownloadDetectFileProcessStatusPerUserList();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tloadDetectFileProcessStatusPerUserList();\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t$(document).on(\"click\", \".list-table th\", function () { if (typeof $(this).attr('id') != typeof undefined) { g_searchListOrderByName = $(this).attr('id'); if (g_searchListOrderByDirection == 'ASC') { g_searchListOrderByDirection = 'DESC'; } else { g_searchListOrderByDirection = 'ASC'; }; g_searchListPageNo = 1; loadDetectFileProcessStatusPerUserList(); }; });\r\n");
 ...
 if ("darkness".equals((String)session.getAttribute("THEMENAME"))) { 
      ...
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tloadDetectFileProcessStatusPerUserList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objSearchResult = g_objDetectFileProcessStatusPerUserList.find('#search-result');\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestDetectFileProcessStatusPerUserListParam(\r\n");
      ...
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif ($(data).find('errorcode').text() != \"0000\") {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자별 검출 파일 처리 현황 조회\", \"사용자별 검출 파일 처리 현황 조회 중 오류가 발생하였습니다.\", $(data).find('errormsg').text());\r\n");
      out.write("\t\t\t\t\treturn false;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar oemName = $(data).find('oemname').text();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tvar htmlContents = '';\r\n");
      out.write("\t\t\t\tif (oemName == \"MOCOMSYS\") {\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"USERNAME\" class=\"ui-state-default\">사용자</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"DETECTFILECOUNT\" class=\"ui-state-default\">전체 검출 파일수</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"NOTPROCESSFILECOUNT\" class=\"ui-state-default\">미처리 파일수</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th colspan=\"4\" class=\"ui-state-default\">가상 디스크</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th rowspan=\"2\" id=\"DELETEFILECOUNT\" class=\"ui-state-default\">삭제 파일수</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<tr>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th id=\"MOVETOVITUALDISKFILECOUNT\" class=\"ui-state-default\">반입</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th id=\"MOVEFROMVITUALDISKFILECOUNT\" class=\"ui-state-default\">반출</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th id=\"MOVETOVITUALDISKFILENOTFOUNDCOUNT\" class=\"ui-state-default\">반입파일 부재</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th id=\"MOVEFROMVITUALDISKFILENOTFOUNDCOUNT\" class=\"ui-state-default\">반출파일 부재</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '</thead>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\thtmlContents += '<th id=\"DETECTFILECOUNT\" class=\"ui-state-default\">전체 검출 파일</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th id=\"NOTPROCESSFILECOUNT\" class=\"ui-state-default\">미처리 파일</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th id=\"ENCODINGFILECOUNT\" class=\"ui-state-default\">암호화 파일</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<th id=\"DELETEFILECOUNT\" class=\"ui-state-default\">삭제 파일</th>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '</thead>';\r\n");
      out.write("\t\t\t\t\thtmlContents += '<tbody>';\r\n");
      out.write("\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar notProcessFileCount = $(this).find('notprocessfilecount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar moveToVitualDiskFileCount = $(this).find('movetovitualdiskfilecount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar moveFromVitualDiskFileCount = $(this).find('movefromvitualdiskfilecount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar moveToVitualDiskFileNotFoundCount = $(this).find('movetovitualdiskfilenotfoundcount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar moveFromVitualDiskFileNotFoundCount = $(this).find('movefromvitualdiskfilenotfoundcount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar deleteFileCount = $(this).find('deletefilecount').text();\r\n");
      out.write("\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + detectFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + notProcessFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + moveToVitualDiskFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + moveFromVitualDiskFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + moveToVitualDiskFileNotFoundCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + moveFromVitualDiskFileNotFoundCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + deleteFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\tvar companyName = $(this).find('companyname').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar deptName = $(this).find('deptname').text();\r\n");
      ...
      out.write("\t\t\t\t\t\t\tvar detectFileCount = $(this).find('detectfilecount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar notProcessFileCount = $(this).find('notprocessfilecount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar encodingFileCount = $(this).find('encodingfilecount').text();\r\n");
      out.write("\t\t\t\t\t\t\tvar deleteFileCount = $(this).find('deletefilecount').text();\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<tr class=\"' + lineStyle + '\">';\r\n");
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      ...
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + detectFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + notProcessFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + encodingFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '<td style=\"text-align: right;\">' + deleteFileCount.replace(/(\\d)(?=(\\d\\d\\d)+(?!\\d))/g, \"$1,\") + ' 건</td>';\r\n");
      out.write("\t\t\t\t\t\t\thtmlContents += '</tr>';\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t});\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\tif (oemName == \"MOCOMSYS\") {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"10\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"7\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t}\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\tif (oemName == \"MOCOMSYS\") {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"9\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\thtmlContents += '<td colspan=\"6\" align=\"center\"><div style=\"padding: 10px 0; text-align: center;\">등록된 사용자별 검출 파일 처리 현황이 존재하지 않습니다.</div></td>';\r\n");
      out.write("\t\t\t\t\t}\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\thtmlContents += '</tr>';\r\n");
 ...
 if (AdminType.ADMIN_TYPE_SITE_ADMIN.equals((String)session.getAttribute("ADMINTYPE"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('사업장 사용자별 검출 파일 처리 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사용자별 검출 파일 처리 현황');\r\n");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t} else if (objTreeReference.get_selected().attr(\"node_type\") == 'dept') {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('부서 사용자별 검출 파일 처리 현황 - [' + objTreeReference.get_text(objTreeReference.get_selected()) + ']');\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t$('.inner-center .pane-header').text('전체 사업장 사용자별 검출 파일 처리 현황');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tg_objDetectFileProcessStatusPerUserList.show();\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(jqXHR, textStatus, errorThrown) {\r\n");
      out.write("\t\t\t\tif (jqXHR.status != 0 && jqXHR.readyState != 0) {\r\n");
      out.write("\t\t\t\t\tdisplayAlertDialog(\"사용자별 검출 파일 처리 현황 조회\", \"사용자별 검출 파일 처리 현황 조회 중 오류가 발생하였습니다.\", jqXHR.statusText + \"(\" + jqXHR.status + \")\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("\tdownloadDetectFileProcessStatusPerUserList = function() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar objTreeReference = $.jstree._reference(g_objOrganizationTree);\r\n");
      out.write("\r\n");
      out.write("\t\tvar targetCompanyId = \"\";\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tvar postData = getRequestCreateDetectFileProcessStatusPerUserListFileParam(\r\n");
      out.write("\t\t\t\ttargetCompanyId,\r\n");
      out.write("\t\t\t\tarrTargetDeptList,\r\n");
      out.write("\t\t\t\tg_searchListOrderByName,\r\n");
      out.write("\t\t\t\tg_searchListOrderByDirection);\r\n");
      out.write("\r\n");
      out.write("\t\topenDownloadDialog(\"사용자별 검출 파일 처리 현황\", \"사용자별 검출 파일 처리 현황\", postData);\r\n");
      out.write("\t};\r\n");
      out.write("//-->\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t<div class=\"pane-header\">전체 사업장 사용자별 검출 파일 처리 현황</div>\r\n");
      out.write("\t<div class=\"ui-layout-content\">\r\n");
      out.write("\t\t<div id=\"detectfileprocessstatusperuser-list\" style=\"display: none;\">\r\n");
